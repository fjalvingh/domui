...
public class PropertyAnnotationProcessor extends AbstractProcessor {
	...
	//String getRootClass(String entityName) {
	//	return entityName + "_Root";					// Artist becomes Artist_
	//}
	...
	//		w.append("\n");
	//		w.append("import org.eclipse.jdt.annotation.*;\n");
	//		w.append("\n");
	//		w.append("@Generated(value = { \"Generated by etc.to PropertyAnnotationProcessor " + VERSION + ".\" })\n");
	//		w.append("public class ").append(className).append(" extends ").append(getLinkClass(targetClassName)).append("<").append(className).append("> {\n");
	//		w.append("}\n");
	//	}
	//}
