...
abstract public class RenderRegistry {
	private Map<Class, ItemRenderer>	m_map	= new HashMap<Class, ItemRenderer>();
	...
	private List<FixPair>				m_fixedList				= new ArrayList<FixPair>();

	/** The list of method names to IGNORE on an object. */
	private Set<String>					m_ignoredMethodSet		= new HashSet<String>();

	/** The list of types that is not to be rendered. */
	private Set<Class>					m_ignoredTypeSet		= new HashSet<Class>();

	private Set<String>					m_ignoredPackageSet		= new HashSet<String>();

	/** Maps primitive types to their array renderer. */
	private Map<Class, ItemRenderer>	m_arrayRendererMap		= new HashMap<Class, ItemRenderer>();
