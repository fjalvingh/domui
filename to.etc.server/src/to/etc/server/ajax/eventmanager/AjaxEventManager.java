...
public class AjaxEventManager {
	...
	private long										m_expiry				= 60 * 1000;

	/** The max #of events that gets returned per call. */
	private int											m_maxevents				= 20;

	/** Default browser timeout is 90 seconds. */
	private long										m_browserTimeout		= 20 * 1000;
	...
	private Map<String, Set<AjaxEventFilterFactory>>	m_eventFilters			= new HashMap<String, Set<AjaxEventFilterFactory>>();
	 ...
	 */
	private synchronized void registerWaiting(final EventCometContext ectx, long timeout) {
