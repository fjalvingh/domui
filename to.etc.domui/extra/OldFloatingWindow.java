 ...
 */
@Deprecated
public class OldFloatingWindow extends Div implements IFloating {
	...
	IClicked<OldFloatingWindow> m_onClose;
	 ...
	 * @param txt
	 */
	protected OldFloatingWindow(boolean modal, String txt) {
		m_modal = modal;
		if(txt != null)
			setWindowTitle(txt);
		init();
	 ...
	 * @return
	 */
	static public OldFloatingWindow create(NodeBase parent) {
		return create(parent, null, true);
	}

	static public OldFloatingWindow create(NodeBase parent, String ttl) {
		return create(parent, ttl, true);
	}

	static public OldFloatingWindow create(NodeBase parent, String ttl, boolean modal) {
		UrlPage body = parent.getPage().getBody();
		OldFloatingWindow w = new OldFloatingWindow(modal, ttl); // Create instance
	...
	public void closePressed() throws Exception {
		close();
		if(m_onClose != null)
			m_onClose.clicked(OldFloatingWindow.this);
	}
	 ...
	 * @return
	 */
	public IClicked<OldFloatingWindow> getOnClose() {
		return m_onClose;
	}
	 ...
	 * @param onClose
	 */
	public void setOnClose(IClicked<OldFloatingWindow> onClose) {
		m_onClose = onClose;
	}
