...
public class DateInput2 extends Text2<Date> {
	...
	public void createContent() throws Exception {
		super.createContent();
		SmallImgButton sib = addButton("THEME/btn-datein.png", a -> { });
		sib.setOnClickJS("WebUI.showCalendar('" + getActualID() + "'," + isWithTime() + ")");
		internalGetInput().setSpecialAttribute("onblur", "WebUI.dateInputCheckInput(event);");
		if(! m_hideTodayButton) {
			SmallImgButton todayBtn = addButton("THEME/btnToday.png", c -> {
