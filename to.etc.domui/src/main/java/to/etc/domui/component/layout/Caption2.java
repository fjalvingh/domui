...
public class Caption2 extends Div {
	...
	public void addButton(@NonNull IIcon image, @Nullable String hint, @NonNull IClicked<NodeBase> handler) {
		SmallImgButton ib = new SmallImgButton(image);
		ib.setClicked(handler);
		internallyAddButton(ib, hint);
	}

	public void addButton(@NonNull IIcon image, @Nullable String hint, @NonNull String onClickJs) {
		SmallImgButton ib = new SmallImgButton(image);
