...
/**
 * Renders the attributes that make a node draggable or a drop target; the browser
 * code in domui.dragdrop.ts acts on those attributes.
 *
...
public final class UIDragDropUtil {
	...
	/**
	 * Expose all droppable thingies on a node.
	 */
