...
final public class FormBuilder {
	static private final String DONOTRENDERLABEL = "$nor$";
...
//		m_layouter = new TableFormLayouter(appender);
	...
	public ItemBuilder controlOnly() {
		check();
		ItemBuilder b = new ItemBuilder().controlOnly();
		m_currentBuilder = b;
		return b;
	}
	...
	private class BuilderData<V> {
		...
		@Nullable
		public NodeContainer determineLabel() {
			NodeContainer res = null;
			String txt = m_nextLabel;
			if(null != txt) {
				if(DONOTRENDERLABEL.equals(txt)) {
					return null;
				}
	...
	public class TypedControlBuilder<I, V> extends BuilderData<V> {
		...
		public TypedControlBuilder<I, V> controlOnly() {
			label(DONOTRENDERLABEL);
			return this;
		}
	...
	final public class UntypedControlBuilder<I> extends BuilderWithInstanceData<I, Object> {
		...
		public UntypedControlBuilder<I> controlOnly() {
			label(DONOTRENDERLABEL);
			return this;
		}
