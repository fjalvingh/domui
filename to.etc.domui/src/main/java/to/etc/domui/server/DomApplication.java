...
public abstract class DomApplication {
	...
	public void addIgnoredUrlPrefix(String prefix) {
	...
	public boolean isIgnoredUrlPrefix(String rurl) {
		for(String prefix : m_ignorePrefixList) {
			if(rurl.startsWith(prefix))
				return true;
		}
		return false;
	}
