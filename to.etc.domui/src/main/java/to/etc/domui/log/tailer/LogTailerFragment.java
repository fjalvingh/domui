...
public class LogTailerFragment extends PollingDiv {
	...
	private void createHeader() {
		...
		SmallImgButton ib = new SmallImgButton(Icon.faAngleDoubleLeft, clickednode -> gotoLine(0));
		btn.add(ib);

		ib = new SmallImgButton(Icon.faAngleLeft, clickednode -> {
		...
		ib = new SmallImgButton(Icon.faAngleRight, clickednode -> {
		...
		ib = new SmallImgButton(Icon.faAngleDoubleRight, clickednode -> gotoLine(m_task.getLastLine() - getLinesPerPage()));
		btn.add(ib);
