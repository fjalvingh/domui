...
(function() {
		...
		CKEDITOR.event || (CKEDITOR.event = function() {
			...
			return {
				define: function(a, b) {
					...
					function q(w, x, z, l) {
						w = {name: b, sender: this, editor: w, data: x, listenerData: h, stop: z, cancel: l, removeListener: g};
					...
					var w = this, x = d.call(this, b);
					if(0 > x.getListenerIndex(c)) {
						x = x.listeners;
						k || (k = this);
						isNaN(l) && (l = 10);
						q.fn = c;
						q.priority = l;
						for(var z = x.length - 1; 0 <= z; z--) if(x[z].priority <= l) return x.splice(z + 1, 0, q), {removeListener: g};
						x.unshift(q)
					}
					...
					return function(l, q, g) {
						...
						if(w) {
							...
							if(z.length) for(var z = z.slice(0),
												 A, t = 0; t < z.length; t++) {
								if(w.errorProof) try {
									A = z[t].call(this, g, q, e, h)
								} catch(m) {
								} else A = z[t].call(this, g, q, e, h);
								A === a ? d = 1 : "undefined" != typeof A && (q = A);
								if(c || d) break
							}
						}
	...
	(function() {
		function a(a, x, b) {
			...
			this._output = CKEDITOR.tools.bind(x, b || {});
			var c = this;
			this.input = function() {
				function a() {
		...
		var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", f = /&/g, e = />/g, k = /</g, h = /"/g,
			l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, q = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, g = function(a, x) {
				return "#" == x[0] ? String.fromCharCode(parseInt(x.slice(1), 10)) : q[x]
			};
		...
		CKEDITOR.tools = {
			arrayCompare: function(a, x) {
				if(!a && !x) return !0;
				if(!a || !x || a.length != x.length) return !1;
				for(var b = 0; b < a.length; b++) if(a[b] != x[b]) return !1;
				return !0
			}, getIndex: function(a, x) {
				for(var b = 0; b < a.length; ++b) if(x(a[b])) return b;
				return -1
			}, clone: function(a) {
				var b;
				...
				a = [].concat(a);
				for(var b, c = [], g = 0; g < a.length; g++) if(b = a[g]) /@import|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : (b = CKEDITOR.appendTimestamp(b), c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e'));
				return c.join("")
				...
				if(!c) {
					var m = /\n{2}/g;
					if(m.test(g)) var e = "\x3c" + h + "\x3e", d = "\x3c/" + h + "\x3e", g = e + g.replace(m, function() {
						return d +
							e
					}) + d
				}
				...
				c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function v() {
				...
				a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, c, w) {
					b && (c =
						c.toLowerCase(), "font-family" == c && (w = w.replace(/\s*,\s*/g, ",")), w = CKEDITOR.tools.trim(w));
					g[c] = w
				});
				return g
				...
				var c = CKEDITOR.env.ie && 8 == CKEDITOR.env.version ? a.toUpperCase() : a, c = b.find("span[style*\x3d" + c + "]").toArray();
			...
			enableHtml5Elements: function(a, b) {
				...
				var c = b & 16711680, g = b & 65535, h = CKEDITOR.env.mac, m = [], e = [];
			...
			getCookie: function(a) {
				...
				if(a) if(window.CSS && CSS.escape) a = CSS.escape(a); else {
					a = String(a);
					for(var b = a.length, c = -1, g, h = "", m = a.charCodeAt(0); ++c < b;) g = a.charCodeAt(c), h = 0 == g ? h + "�" : 127 == g || 1 <= g && 31 >= g || 0 == c && 48 <=
					g && 57 >= g || 1 == c && 48 <= g && 57 >= g && 45 == m ? h + ("\\" + g.toString(16) + " ") : 0 == c && 1 == b && 45 == g ? h + ("\\" + a.charAt(c)) : 128 <= g || 45 == g || 95 == g || 48 <= g && 57 >= g || 65 <= g && 90 >= g || 97 <= g && 122 >= g ? h + a.charAt(c) : h + ("\\" + a.charAt(c));
					a = h
				} else a = "";
				return a
				...
				var b = "", c = a.length, g;
				for(g = 0; g < c; g += 3) {
					var h = a.slice(g, g + 3), m = h.length, e = [], d;
	...
	CKEDITOR.dtd = function() {
		var a = CKEDITOR.tools.extend, d = function(a, b) {
			...
			table: 1,
			ul: 1
		}, e = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, h = {"#": 1}, l = {center: 1, dir: 1, noframes: 1};
		a(b, {
			a: 1,
			abbr: 1,
			area: 1,
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			is: function() {
				...
				if(document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					var f = this.$.getBoundingClientRect(), k = g.$.documentElement, t = k.clientTop || d.$.clientTop || 0, m = k.clientLeft || d.$.clientLeft || 0, M = !0;
					CKEDITOR.env.ie && (M = g.getDocumentElement().contains(this), g = g.getBody().contains(this), M = e && g || !e && M);
					M && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || k.scrollLeft, c = d.$.scrollTop || k.scrollTop) : (c = e ? d.$ : k, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - m, c = f.top + c - t)
				} else for(t = this, m = null; t && "body" != t.getName() &&
				"html" != t.getName();) {
				...
				e = a.getWindow();
				d = t(this, e);
				var v = t(a, e), J = this.$.offsetHeight;
				g = this.$.offsetWidth;
				var E = a.$.clientHeight, u = a.$.clientWidth;
	...
	(function() {
		function a(a, b) {
			...
			g = c.endContainer;
			var e = c.startOffset, f = c.endOffset, w, h = this.guard, k = this.type, q = a ? "getPreviousSourceNode" : "getNextSourceNode";
			if(!a && !this._.guardLTR) {
				var l = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), y = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext();
			...
			if(a && !this._.guardRTL) {
				var K = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), r = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
			...
			this.current ? g = this.current[q](!1, k, w) : (a ? g.type == CKEDITOR.NODE_ELEMENT &&
				(g = 0 < f ? g.getChild(f - 1) : !1 === w(g, !0) ? null : g.getPreviousSourceNode(!0, k, w)) : (g = d, g.type == CKEDITOR.NODE_ELEMENT && ((g = g.getChild(e)) || (g = !1 === w(d, !0) ? null : d.getNextSourceNode(!0, k, w)))), g && !1 === w(g) && (g = null));
			for(; g && !this._.end;) {
				this.current = g;
		...
		var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, e = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp(), l = function(a) {
		...
		var g = CKEDITOR.dom.walker.empty(), w = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function(a) {
			var b = {}, c;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b =
					q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(w) && g(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, d, e) {
			...
			function m() {
				var a, b, c, g = Math.min(O.length, p.length);
				for(a = 0; a < g; a++) if(b = O[a], c = p[a], !b.equals(c)) return a;
				return a - 1
			}

			function h() {
				var b = I - 1, c = D && B && !u.equals(F);
				b < N - 1 || b < n - 1 || c ? (c ? a.moveToPosition(F,
			...
			b = l || q;
			var u = a.startContainer, F = a.endContainer,
				H = a.startOffset, y = a.endOffset, K, r, D, B, G, T;
			if(l && F.type == CKEDITOR.NODE_TEXT && (u.equals(F) || u.type === CKEDITOR.NODE_ELEMENT && u.getFirst().equals(F))) c.append(a.document.createText(F.substring(H, y))); else {
				F.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : F = F.split(y) : 0 < F.getChildCount() ? y >= F.getChildCount() ? (F = F.getChild(y - 1), r = !0) : F = F.getChild(y) : B = r = !0;
				u.type == CKEDITOR.NODE_TEXT ? l ? G = !0 : u.split(H) : 0 < u.getChildCount() ? 0 === H ? (u = u.getChild(H), K = !0) : u = u.getChild(H - 1) : D = K = !0;
				for(var O = u.getParents(), p = F.getParents(), I = m(),
						N = O.length - 1, n = p.length - 1, C = c, L, aa, X, ea = -1, W = I; W <= N; W++) {
					aa = O[W];
					X = aa.getNext();
					for(W != N || aa.equals(p[W]) && N < n ? b && (L = C.append(aa.clone(0, e))) : K ? f(aa, C, !1, D) : G && C.append(a.document.createText(aa.substring(H))); X;) {
						if(X.equals(p[W])) {
							ea = W;
							break
						}
				...
				C = c;
				for(W = I; W <= n; W++) if(c = p[W], X = c.getPrevious(), c.equals(O[W])) b && (C = C.getChild(0)); else {
					W != n || c.equals(O[W]) && n < N ? b && (L = C.append(c.clone(0, e))) : r ? f(c, C, !1, B) : T && C.append(a.document.createText(c.substring(0, y)));
		...
		var e = {
			...
			u: 1,
			"var": 1
		}, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), q = CKEDITOR.dom.walker.ignored(!0);
		CKEDITOR.dom.range.prototype = {
			clone: function() {
				...
				var c = this.startContainer, d = this.endContainer, e = this.collapsed, f, m, h, k;
				...
				e || (m = f.clone(), m.setHtml("\x26nbsp;"), a && m.setAttribute("id", h + "E"), k = this.clone(), b(d) && (d = b(d),
				...
				switch(a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						var m = this.getCommonAncestor(), h = this.root, k, q, l, u, F, H = !1, y, K;
						y = this.startContainer;
						var r = this.startOffset;
						y.type == CKEDITOR.NODE_TEXT ? (r && (y = !CKEDITOR.tools.trim(y.substring(0, r)).length && y, H = !!y), y && ((u = y.getPrevious()) || (l = y.getParent()))) : (r && (u = y.getChild(r - 1) || y.getLast()), u || (l = y));
						for(l = c(l); l || u;) {
							if(l && !u) {
								!F && l.equals(m) && (F = !0);
							...
							for(; u;) if(y = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious(); else {
								if(u.type == CKEDITOR.NODE_TEXT) K = u.getText(), d.test(K) && (u = null), y = /[\s\ufeff]$/.test(K); else if((u.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && u.is("br")) && !u.data("cke-bookmark")) if(H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
									K = u.getText();
									if(d.test(K)) u = null; else for(var r = u.$.getElementsByTagName("*"), D = 0, B; B = r[D++];) if(!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
										u = null;
										break
									}
									u && (y = !!K.length)
								} else u = null;
								y && (H ? F ? k = l : l && this.setStartBefore(l) : H = !0);
								if(u) {
									y = u.getPrevious();
									if(!l && !y) {
										l = u;
						...
						l = u = null;
						F = H = !1;
						y.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(y.substring(r)).length ? H = !0 : (H = !y.getLength(), r == y.getLength() ? (u = y.getNext()) || (l = y.getParent()) :
							f(y, r) && (l = y.getParent())) : (u = y.getChild(r)) || (l = y);
						for(; l || u;) {
							if(l && !u) {
								!F && l.equals(m) && (F = !0);
								if(e ? l.isBlockBoundary() : !h.contains(l)) break;
								H && "inline" == l.getComputedStyle("display") || (H = !1, F ? q = l : l && this.setEndAfter(l));
								u = l.getNext()
							}
							for(; u;) {
								y = !1;
								if(u.type == CKEDITOR.NODE_TEXT) K = u.getText(), f(u, 0) || (u = null), y = /^[\s\ufeff]/.test(K); else if(u.type == CKEDITOR.NODE_ELEMENT) {
									if((0 < u.$.offsetWidth || b && u.is("br")) && !u.data("cke-bookmark")) if(H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
										K = u.getText();
										if(d.test(K)) u =
											null; else for(r = u.$.getElementsByTagName("*"), D = 0; B = r[D++];) if(!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
											u = null;
											break
										}
										u && (y = !!K.length)
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						var G, T, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), p = null, I = function(a) {
						...
						G = G || h;
						this.setStartAt(G,
							!G.is("br") && (!l && this.checkStartOfBlock() || l && G.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
						if(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
							l = this.clone();
							l = new CKEDITOR.dom.walker(l);
							var N = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark();
						...
						l = new CKEDITOR.dom.walker(l);
						l.guard =
							a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : I;
						G = p = T = null;
						l = l.lastForward();
						G = G || h;
						this.setEndAt(G, !l && this.checkEndOfBlock() || l && G.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
				...
				if(!this.collapsed) {
					...
					var f = new CKEDITOR.dom.walker(f), u = CKEDITOR.dom.walker.bookmark(), F = CKEDITOR.dom.walker.bogus();
					...
					f.guard = function(b, c) {
						...
						if(a == CKEDITOR.SHRINK_ELEMENT &&
							b.type == CKEDITOR.NODE_TEXT || c && b.equals(H) || !1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
				...
				var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, f = d.block, m = null;
				...
				this.deleteContents();
				e && e.equals(f) && (d ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END), f = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (f = this.splitElement(e, b ||
				...
				var c, d = 0, e, f, m = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
			...
			moveToElementEditEnd: function(a) {
				...
				var b = this.getTouchedStartNode(), c = this.getTouchedEndNode(), d = b.getAscendant("table", !0), c = c.getAscendant("table", !0);
				...
				var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], f, m, h, k;
				if(c && c.find) for(m = c.find(a), f = 0; f < m.count(); f++) if(c = m.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
		...
		CKEDITOR.dom.range.mergeRanges = function(a) {
			return CKEDITOR.tools.array.reduce(a, function(a, b) {
				...
				if(c) {
					var e = new CKEDITOR.dom.range(b.root), d = new CKEDITOR.dom.walker(e), g = CKEDITOR.dom.walker.whitespaces();
		...
		a.prototype = {
			getNextParagraph: function(a) {
				...
				if(!this._.started) {
					...
					k = t.startPath();
					var m = t.endPath(), M = !t.collapsed && c(t, k.block), v = !t.collapsed && c(t, m.block, 1);
					...
					(m = new CKEDITOR.dom.elementPath(m.endContainer, m.root), this._.lastNode = (m.block || m.blockLimit).getNextSourceNode(!0))), this._.lastNode && t.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = t.document.createText(""), this._.lastNode.insertAfter(k)), t = null);
					this._.started = 1;
					k = t
				}
				m = this._.nextNode;
				...
				for(this._.nextNode = null; m;) {
					var M = 0, v = m.hasAscendant("pre"), J = m.type != CKEDITOR.NODE_ELEMENT, E = 0;
					if(J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0); else {
						var u = m.getName();
						if(CKEDITOR.dtd.$block[u] && "false" == m.getAttribute("contenteditable")) {
							...
							if("br" == u) J = 1; else if(!k && !m.getChildCount() && "hr" != u) {
								d = m;
								x = m.equals(t);
								break
							}
				...
				A && (z = d.getLast()) && z.type == CKEDITOR.NODE_ELEMENT && "br" == z.getName() && (!CKEDITOR.env.needsBrFiller || z.getPrevious(e) || z.getNext(e)) && z.remove();
				this._.nextNode || (this._.nextNode = x || d.equals(t) || !t ? null : this._getNextSourceNode(d, 1, t));
				return d
	...
	(function() {
		function a(a, b, c, d, e) {
			...
			for(f in b) {
				...
				for(p in T) {
					n[p] = k(n[p], r) || null;
					var B = n, m = O[p], y = k(n[O[p]], r), h = n[p], C = [], G = !0, I = void 0;
					y ? G = !1 : y = {};
					for(I in h) "!" == I.charAt(0) && (I = I.slice(1), C.push(I), y[I] = !0, G = !1);
					for(; I = C.pop();) h[I] =
						h["!" + I], delete h["!" + I];
					B[m] = (G ? !1 : y) || null
				}
			...
			for(d = a.length; c < d; ++c) {
				...
				for(p in O) {
					...
					y = [];
					h = void 0;
					for(h in m) -1 < h.indexOf("*") ? y.push(new RegExp("^" + h.replace(/\*/g, ".*") + "$")) : y.push(h);
					m = y;
					m.length && (n[r] = m, B = !1)
				}
				n.nothingRequired = B;
		...
		function g(a) {
			var b, c, d, e, f = {}, g = 1;
			for(a = B(a); b = a.match(p);) (c = b[2]) ? (d = w(c, "styles"), e = w(c, "attrs"), c = w(c, "classes")) : d = e = c = null, f["$" + g++] = {
				elements: b[1],
				classes: c,
				styles: d,
				attributes: e
		...
		function z(a, b, e, f) {
			...
			if(f.doCallbacks && a.elementCallbacks) {
				a:{
					...
					for(var p = 0, B = r.length, D; p < B; ++p) if(D = r[p](b)) {
						r = D;
						break a
					}
					r = void 0
			...
			if(f.doTransform && (r = a._.transformations[b.name])) {
				x(b);
				for(p = 0; p < r.length; ++p) u(a, b, r[p]);
				t(b)
			}
			if(f.doFilter) {
				a:{
					p = b.name;
					B = a._;
					a = B.allowedRules.elements[p];
					r = B.allowedRules.generic;
					p = B.disallowedRules.elements[p];
					...
					if(a || r) {
						x(b);
						if(p) for(y = 0, h = p.length; y < h; ++y) if(!1 === c(p[y], b, k)) {
							a = null;
							break a
						}
						if(B) for(y = 0, h = B.length; y < h; ++y) c(B[y], b, k);
						if(a) for(y = 0, h = a.length; y < h; ++y) d(a[y], b, k, D);
						if(r) for(y = 0, h = r.length; y < h; ++y) d(r[y], b, k, D);
						a = k
					} else a = null
				}
				...
				var C = a.validStyles;
				r = a.validClasses;
				var p = b.attributes, G = b.styles, B = b.classes;
				D = b.classBackup;
				var O = b.styleBackup, I, l, K = [], k = [], T = /^data-cke-/;
				y = !1;
				delete p.style;
				delete p["class"];
				delete b.classBackup;
				delete b.styleBackup;
				if(!a.allAttributes) for(I in p) h[I] || (T.test(I) ? I == (l = I.replace(/^data-cke-saved-/, "")) || h[l] || (delete p[I], y = !0) : (delete p[I], y = !0));
				if(!a.allStyles || a.hadInvalidStyle) {
					for(I in G) a.allStyles || C[I] ? K.push(I + ":" + G[I]) : y = !0;
					K.length && (p.style = K.sort().join("; "))
				} else O && (p.style = O);
				if(!a.allClasses ||
					a.hadInvalidClass) {
					for(I = 0; I < B.length; ++I) (a.allClasses || r[B[I]]) && k.push(B[I]);
					k.length && (p["class"] = k.sort().join(" "));
					D && k.length < D.split(/\s+/).length && (y = !0)
				} else D && (p["class"] = D);
				y && (g = 1);
		...
		function E(a, b, c) {
			var d = a.name;
			if(r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({
				check: "it",
				el: a.parent
			}), a.remove()); else if(r.$block[d] || "tr" == d) if("br" == b) a.previous && !J(a.previous) && (b = v(), b.insertBefore(a)), a.next && !J(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren(); else {
				var d = a.children, e;
				b:{
					e = r[b];
					for(var f = 0, g = d.length, n; f < g; ++f) if(n = d[f], n.type == CKEDITOR.NODE_ELEMENT && !e[n.name]) {
						e = !1;
						break b
					}
					e = !0
				...
				if(e) a.name = b, a.attributes =
					...
					e = a.parent;
					for(var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, p, B, g = d.length; 0 < g;) n = d[--g], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && r.$inline[n.name]) ? (p || (p = new CKEDITOR.htmlParser.element(b), p.insertAfter(a), c.push({
						check: "parent-down",
						el: p
					})), p.add(n, 0)) : (p = null, B = r[e.name] || r.span, n.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || B[n.name] || c.push({
						check: "el-up",
						el: n
					}));
					a.remove()
		...
		function F(a, b) {
			var c = b.getDefinition(), d = c.attributes, e = c.styles, f, g, n, r;
			if(a.name != c.element) return !1;
			for(f in d) if("class" == f) for(c = d[f].split(/\s+/), n = a.classes.join("|"); r = c.pop();) {
		...
		var r = CKEDITOR.dtd, D = CKEDITOR.tools.copy, B = CKEDITOR.tools.trim, G = ["", "p", "br", "div"];
		...
		CKEDITOR.filter = function(a, b) {
			...
			if(c && !b) {
				...
				!0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(G[c.enterMode] +
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, d) {
				...
				var e = this, f = [], g = this.editor && this.editor.config.protectedSource, n, p = !1, B = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
				a.forEach(function(a) {
					if(a.type == CKEDITOR.NODE_ELEMENT) {
						if("off" == a.attributes["data-cke-filter"]) return !1;
						if(!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if(n = z(e, a, f, B), n & 1) p = !0; else if(n & 2) return !1
						...
						a:{
							...
							c = [];
							var r, D, m;
							if(g) for(D = 0; D < g.length; ++D) if((m = d.match(g[D])) && m[0].length == d.length) {
								c =
									!0;
								break a
							}
							d = CKEDITOR.htmlParser.fragment.fromHtml(d);
							1 == d.children.length && (r = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, r, c, B);
							c = !c.length
						}
						c || f.push(a)
					}
				...
				for(var y; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a) : c.remove();
				for(; D = a.pop();) if(c = D.el, c.parent) switch(y = r[c.parent.name] || r.span, D.check) {
					case "it":
						r.$removeEmpty[c.name] && !c.children.length ? E(c, d, a) : m(c) || E(c, d, a);
						break;
					case "el-up":
						c.parent.type ==
						CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || E(c, d, a);
						break;
					case "parent-down":
						c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || E(c.parent, d, a)
				}
				return p
			...
			addContentForms: function(a) {
				...
				if(!this.disabled && a) {
					...
					for(e = 0; e < a.length; ++e) {
						b = a[e];
						var f = void 0, g = void 0, n = void 0, r = void 0, p = void 0, B = void 0;
						c = [];
						for(g = 0; g < b.length; ++g) n = b[g], "string" == typeof n ? (n = n.split(/\s*:\s*/), r = n[0], p = null, B = n[1]) : (r = n.check, p = n.left, B = n.right), f || (f = n, f = f.element ? f.element : r ? r.match(/^([a-z0-9]+)/i)[0] :
							f.left.getDefinition().element), p instanceof CKEDITOR.style && (p = y(p)), c.push({check: r == f ? null : r, left: p, right: "string" == typeof B ? K(B) : B});
						b = f;
						d[b] || (d[b] = []);
						d[b].push(c)
					}
				...
				} else e = a.getDefinition(), n = e.styles, d = e.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = D(n), d.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, e = {
					name: e.element,
					attributes: d,
				...
				var n = CKEDITOR.tools.clone(e), r = [], p;
				if(!1 !== b && (p = this._.transformations[e.name])) {
					for(d =
							0; d < p.length; ++d) u(this, e, p[d]);
					t(e)
				}
				z(this, n, r, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
				0 < r.length ? c = !1 : ((b = e.attributes["class"]) && (e.attributes["class"] = e.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(e.attributes, n.attributes, !0), b && (e.attributes["class"] = b));
		...
		var T = {styles: 1, attributes: 1, classes: 1}, O = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
			p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
			I = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, N = /^cke:(object|embed|param)$/, n = /^(object|embed|param)$/, C;
		C = CKEDITOR.filter.transformationsTools = {
			sizeToStyle: function(a) {
				...
				if("string" == typeof b) a.name = b; else {
					var c = b.getDefinition(), d = c.styles, e = c.attributes, f, n, g, r;
					a.name = c.element;
					for(f in e) if("class" ==
						f) for(c = a.classes.join("|"), g = e[f].split(/\s+/); r = g.pop();) -1 == c.indexOf(r) && a.classes.push(r); else a.attributes[f] = e[f];
	...
	CKEDITOR.scriptLoader = function() {
		...
		return {
			load: function(b, c, f, e) {
				...
				k && (b = [b]);
				f || (f = CKEDITOR);
				var h = b.length, l = h, q = [], g = [], w = function(a) {
		...
		return function(b, c, f) {
			var e = {}, k = function(b) {
				a.call(this, b, function(a) {
					...
					var b = [], g;
					for(g in a) {
						var h = a[g], x = h && h.requires;
						if(!d[g]) {
							if(h.icons) for(var z = h.icons.split(","), A = z.length; A--;) CKEDITOR.skin.addIcon(z[A], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[A] + ".png");
	...
	(function() {
		...
		function w(a) {
			...
			if(e) var g = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g, ""), d = d + ("," + e);
			...
			CKEDITOR.plugins.load(d.split(","),
				function(b) {
					...
					for(var g in b) {
						var k = b[g], l = k.lang, O = null, p = k.requires, I;
						CKEDITOR.tools.isArray(p) && (p = p.join(","));
						if(p && (I = p.match(h))) for(; p = I.pop();) CKEDITOR.error("editor-plugin-required", {plugin: p.replace(",", ""), requiredBy: g});
						l && !a.lang[g] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ? O = a.langCode : (O = a.langCode.replace(/-.*/, ""), O = O != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, O) ? O : 0 <= CKEDITOR.tools.indexOf(l,
							"en") ? "en" : l[0]), k.langEntries && k.langEntries[O] ? (a.lang[g] = k.langEntries[O], O = null) : f.push(CKEDITOR.getUrl(k.path + "lang/" + O + ".js")));
						e.push(O);
						d.push(k)
					}
					CKEDITOR.scriptLoader.load(f, function() {
						if(!a.isDestroyed() && !a.isDetached()) {
							for(var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++) for(var g = 0; g < d.length; g++) {
								var p = d[g];
								0 === f && e[g] && p.lang && p.langEntries && (a.lang[p.name] = p.langEntries[e[g]]);
								if(p[b[f]]) p[b[f]](a)
							}
		...
		function z(a, b) {
			...
			for(var e = new CKEDITOR.dom.documentFragment, f, g, h, k = 0; k < a.length; k++) {
				...
				c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({thead: 1, tbody: 1, tfoot: 1}).clone()), e.append(f),
		...
		CKEDITOR.editor.initializeDelayedEditorCreation =
			function(a, b, c) {
				if(b.delayIfDetached_callback) CKEDITOR.warn("editor-delayed-creation", {method: "callback"}), b.delayIfDetached_callback(function() {
					...
					var d = void 0 === b.delayIfDetached_interval ? CKEDITOR.config.delayIfDetached_interval : b.delayIfDetached_interval, e;
	...
	(function() {
		...
		var d = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = {ol: 1, ul: 1},
			...
			function(e, k, h) {
				function l(a) {
					...
					if(0 < m.length) for(var c = 0; c < m.length; c++) {
						var d = m[c], e = d.name, f = CKEDITOR.dtd[e], g = v.name && CKEDITOR.dtd[v.name];
						g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == v.name && (w(v, v.parent, 1), c--) : (b || (q(), b = 1), d = d.clone(), d.parent = v, v = d, m.splice(c, 1), c--)
					}
				}
				...
				function w(b, c, d) {
					c = c || v || t;
					var e = v;
					void 0 === b.previous && (x(c, b) && (v = c, A.onTagOpen(h, {}), b.returnPoint = c = v), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (E = !1), "textarea" == b.name && (J = !1));
				...
				var A = new CKEDITOR.htmlParser, t = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment,
					m = [], M = [], v = t, J = "textarea" == t.name, E = "pre" == t.name;
					...
					if(a(f)) m.push(f); else {
						...
						if("br" == e) M.push(f); else {
							for(; !(h = (g = v.name) ? CKEDITOR.dtd[g] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || v.isUnknown || h[e]);) if(v.isOptionalClose) A.onTagClose(g); else if(e in b && g in b) g = v.children, (g = g[g.length - 1]) && "li" == g.name || w(g = new CKEDITOR.htmlParser.element("li"), v), !f.returnPoint && (f.returnPoint = v), v = g; else if(e in CKEDITOR.dtd.$listItem &&
								!z(e, g)) A.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if(g in d && !z(e, g)) !f.returnPoint && (f.returnPoint = v), v = v.parent; else if(g in CKEDITOR.dtd.$inline && m.unshift(v), v.parent) w(v, v.parent, 1); else {
								f.isOrphan = 1;
								break
							}
							l(e);
				...
				A.onTagClose = function(a) {
					...
					for(var c = [], d = [], e = v; e != t && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
					if(e != t) {
				...
				A.onText = function(a) {
					...
					var b = v.name, e = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
					if(!J && !e["#"] && b in d) A.onTagOpen(f[b] || ""), A.onText(a); else {
						q();
						l();
						E || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
						a = new CKEDITOR.htmlParser.text(a);
						if(x(v, a)) this.onTagOpen(h, {}, 0, 1);
						v.add(a)
					}
				};
				A.onCDATA =
		...
		a.prototype = {
			add: function(a, c, d) {
				this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: d})
								 ...
								 c, d) {
				for(var e = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++) e.push({value: a[k], priority: c, options: d});
				this.rules.splice.apply(this.rules, e)
			}, findIndex: function(a) {
				for(var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;) d--;
				return d + 1
			}, exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, l, q, g, w;
				for(w = 0; w < h; w++) if(d && (l = c.type, q = c.name), g = k[w], !(a.nonEditable && !g.options.applyToAll ||
	...
	(function() {
		function a(a, d) {
			...
			function r(a, d) {
				return function(f) {
					if(f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var n = [], r = b(f), B, h;
						if(r) for(p(r, 1) && n.push(r); r;) e(r) && (B = c(r)) && p(B) && ((h = c(B)) && !e(h) ? n.push(B) : (g(D).insertAfter(B), B.remove())), r = r.previous;
						for(r = 0; r < n.length; r++) n[r].remove();
						if(n = !a || !1 !== ("function" == typeof d ? d(f) : d)) D || CKEDITOR.env.needsBrFiller ||
						f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? D || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (n = b(f), n = !n || "form" == f.name && "input" == n.name) : n = !1 : n = !1;
						n && f.add(g(a))
					}
				}
			}
			...
			var B = {elements: {}}, D = "html" == d, h = CKEDITOR.tools.extend({}, u), y;
			for(y in h) "#" in J[y] || delete h[y];
			for(y in h) B.elements[y] = r(D, a.config.fillEmptyBlocks);
			B.root = r(D, !1);
		...
		CKEDITOR.htmlDataProcessor = function(b) {
			...
			b.on("toHtml", function(a) {
				a = a.data;
				var c = a.dataValue, e, c = m(c), c = t(c, b), c = g(c, T), c = q(c), c = g(c, G), c = c.replace(p, "$1cke:$2"), c = c.replace(N, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml: function(a, b, c, d) {
				var e = this.editor, f, g, r, p;
				b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, g = b.filter, r = b.enterMode, p = b.protectedWhitespaces) : f = b;
		...
		var M =
				/(?:&nbsp;|\xa0)$/, v = "{cke_protected}", J = CKEDITOR.dtd, E = "caption colgroup col thead tfoot tbody".split(" "), u = CKEDITOR.tools.extend({}, J.$blockLimit, J.$block),
			F = {elements: {input: h, textarea: h}}, H = {
				...
				elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus", ""]], elements: {
					$: function(a) {
						...
						a.children.slice(0).sort(function(a, b) {
							var c, d;
							a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(E, a.name), d = CKEDITOR.tools.indexOf(E, b.name));
		...
		CKEDITOR.env.ie && (K.attributes.style = function(a) {
			return a.replace(/(^|;)([^\:]+)/g, function(a) {
				return a.toLowerCase()
			})
		});
		var r = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, B = /^(href|src|name)$/i,
			G = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, O = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
			p = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
			I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
		m = function() {
			function a(b, c) {
	...
	(function() {
		CKEDITOR.inline = function(a, d) {
			...
			var b = a.is("textarea") ? a : null, c = b ? b.getValue() : a.getHtml(), f = new CKEDITOR.editor(d, a, CKEDITOR.ELEMENT_MODE_INLINE);
	...
	(function() {
		...
		function b(a) {
			var b = a.name, d =
					a.element, k = a.elementMode, h = a.fire("uiSpace", {space: "top", html: ""}).html, l = a.fire("uiSpace", {space: "bottom", html: ""}).html,
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
			var h =
				this.container, l = this.ui.space("contents"), q = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
	...
	(function() {
		function a(a) {
			var b = a.editor, e = a.data.path, g = e.blockLimit, f = a.data.selection, h = f.getRanges()[0], k;
			if(CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if(f = d(f, e)) f.appendBogus(), k = CKEDITOR.env.ie && !CKEDITOR.env.edge || CKEDITOR.env.edge && b._.previousActive;
			l(b, e.block, g) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (e = h.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), g = new CKEDITOR.dom.walker(e), g.guard = function(a) {
		...
		function k(a) {
			...
			var d, g = a.getRanges()[0], f = a.root;
		...
		var z, A, t, m, M, v, J, E, u, F, H = {ul: 1, ol: 1, dl: 1};
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			base: CKEDITOR.dom.element, $: function(a, b) {
				...
				restoreAttrs: function() {
					...
					b.deleteContents(1);
					b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1}) ? J(b) : b.startContainer.is(CKEDITOR.dtd.$list) &&
						E(b));
					var h, k;
					if(f) for(; (h = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[h.getName()]) && (!k || !k[e]);) if(h.getName() in CKEDITOR.dtd.span) {
						var f = b.splitElement(h), p = b.createBookmark();
						g(h);
						g(f);
						b.moveToBookmark(p)
					...
					if(!this.is("textarea")) {
						...
						if(B) {
							var f = g.getHead(), G = f.getCustomData("stylesheet");
							G ? B != G.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? G.$.styleSheet.cssText = B : G.setText(B)) : (B = g.appendStyleText(B), B = new CKEDITOR.dom.element(B.ownerNode || B.owningElement), f.setCustomData("stylesheet",
								B), B.data("cke-temp", 1))
						}
						...
						this.attachListener(a, "key", function(b) {
							...
							var c = b.data.domEvent.getKey(), d, g = a.getSelection();
							if(0 !== g.getRanges().length) {
								if(c in
									l) {
									var f;
									b = g.getRanges()[0];
									var r = b.startPath(), B, D, G, c = 8 == c, q = !1;
									if(CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement(); else if(e(g)) {
										var m = new CKEDITOR.dom.walker(b), w = b.collapsed ? b.startContainer : m.next(), q = !1, K;
		...
		v =
			function() {
				...
				function b(c, d) {
					var e, g, f, p, h = [], k = d.range.startContainer;
					e = d.range.startPath();
					for(var k = m[k.getName()], r = 0, B = c.getChildren(), D = B.count(), G = -1, l = -1, I = 0, N = e.contains(m.$list); r < D; ++r) e = B.getItem(r), a(e) ? (f = e.getName(), N && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (p = !!k[f], "br" != f || !e.data("cke-eol") || r && r != D - 1 || (I = (g = r ? h[r - 1].node : B.getItem(r + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != G || p || (G = r), p || (l = r), h.push({
						isElement: 1,
						isLineBreak: I, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: f, allowed: p
					}), g = I = 0)) : h.push({isElement: 0, node: e, allowed: 1});
				...
				function d(b, c) {
					var e = [], g = b.getChildren(), f = g.count(), p, h = 0, k = m[c], B = !b.is(m.$inline) || b.is("br");
					for(B && e.push(" "); h < f; h++) p = g.getItem(h), a(p) && !p.is(k) ? e = e.concat(d(p, c)) : e.push(p);
					B && e.push(" ");
					return e
				}
				...
				function h(b, c, d, e) {
					...
					(f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && p[f.getName()] && (r = f.getPrevious()) && a(r) && !r.getParent().equals(b.startContainer) && d.contains(r) && e.contains(f) && f.isIdentical(r) && (f.moveChildren(r), f.remove(), h(b, c, d, e))
				}
				...
				var m = CKEDITOR.dtd, p = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1},
					I = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, N = CKEDITOR.tools.extend({}, m.$inline);
				delete N.br;
				return function(p, C, L, w) {
					var t = p.editor, u = !1, x;
					"unfiltered_html" == C && (C = "html", u = !0);
					if(!w.checkReadOnly()) {
						var z = (new CKEDITOR.dom.elementPath(w.startContainer, w.root)).blockLimit ||
							w.root;
						C = {type: C, dontFilter: u, editable: p, editor: t, range: w, blockLimit: z, mergeCandidates: [], zombies: []};
						var u = C.range, z = C.mergeCandidates, v = "html" === C.type, A, S, V, F, H;
						"text" == C.type && u.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (S = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", u.document), u.insertNode(S), u.setStartAfter(S));
						...
						for(; (H = e(u)) && a(H) && H.isBlockBoundary() && V.contains(H);) u.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END);
						h(u, C.blockLimit, V, F);
						S && (u.setEndBefore(S), u.collapse(), S.remove());
						S = u.startPath();
						if(A = S.contains(f, !1, 1)) x = u.splitElement(A), C.inlineStylesRoot = A, C.inlineStylesPeak = S.lastElement;
						S = u.createBookmark();
						v && (g(A), g(x));
						(A = S.startNode.getPrevious(c)) && a(A) && f(A) && z.push(A);
						(A = S.startNode.getNext(c)) && a(A) &&
						f(A) && z.push(A);
						for(A = S.startNode; (A = A.getParent()) && f(A);) z.push(A);
						u.moveToBookmark(S);
						x = p.getHtml();
						x = "" === x || x.match(M);
						t.enterMode === CKEDITOR.ENTER_DIV && x && ((t = p.getFirst()) && t.remove(), w.setStartAt(p, CKEDITOR.POSITION_AFTER_START), w.collapse(!0));
						if(p = L) {
							p = C.range;
							if("text" == C.type && C.inlineStylesRoot) {
								w = C.inlineStylesPeak;
								t = w.getDocument().createText("{cke-peak}");
								for(x = C.inlineStylesRoot.getParent(); !w.equals(x);) t = t.appendTo(w.clone()), w = w.getParent();
							...
							w = p.document.createElement("body");
							w.setHtml(L);
							J && (w.getFirst().remove(), w.getLast().remove());
							if((J = p.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a:{
								var Q;
								if(1 ==
									w.getChildCount() && a(Q = w.getFirst()) && Q.is(I) && !Q.hasAttribute("contenteditable")) {
									J = Q.getElementsByTag("*");
									p = 0;
									for(x = J.count(); p < x; p++) if(t = J.getItem(p), !t.is(N)) break a;
						...
						if(p) {
							...
							var E, J = [], ca, P;
							L = S = 0;
							var U, t = Q.startContainer;
							H = C.endPath.elements[0];
							var R, u = H.getPosition(t), z = !!H.getCommonAncestor(t) && u != CKEDITOR.POSITION_IDENTICAL && !(u & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
								t = b(C.dataWrapper, C);
							for(C.editor.enterMode !== CKEDITOR.ENTER_BR && k(t, Q); x < t.length; x++) {
								u = t[x];
								if(v = u.isLineBreak) v = Q, A = w, F = V = void 0, u.hasBlockSibling ? v = 1 : (V = v.startContainer.getAscendant(m.$block, 1)) && V.is({
									div: 1,
									p: 1
								}) ? (F = V.getPosition(A), F == CKEDITOR.POSITION_IDENTICAL || F == CKEDITOR.POSITION_CONTAINS ? v = 0 : (A = v.splitElement(V), v.moveToPosition(A, CKEDITOR.POSITION_AFTER_START), v = 1)) : v = 0;
								if(v) L = 0 < x; else {
									v = Q.startPath();
									!u.isBlock && l(C.editor, v.block, v.blockLimit) && (P = q(C.editor)) && (P = p.createElement(P),
										P.appendBogus(), Q.insertNode(P), CKEDITOR.env.needsBrFiller && (E = P.getBogus()) && E.remove(), Q.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END));
									...
									if(S && u.isElement) {
										...
										if(v) A && (U = Q.splitElement(A), C.zombies.push(U), C.zombies.push(A)); else {
											A = w.getName();
											R = !x;
											v = x == t.length - 1;
											A = d(u.node, A);
											V = [];
											F = A.length;
											for(var Z = 0, Y = void 0, da = 0, fa = -1; Z < F; Z++) Y = A[Z], " " == Y ? (da || R && !Z || (V.push(new CKEDITOR.dom.text(" ")), fa = V.length), da = 1) : (V.push(Y), da = 0);
											v && fa == V.length && V.pop();
											R = V
										}
									}
									...
									u.lastNotAllowed && x < t.length - 1 && ((U = z ? H : U) && Q.setEndAt(U, CKEDITOR.POSITION_AFTER_START), S = 0);
									Q.collapse()
								}
							}
							1 != t.length ? E = !1 : (E = t[0], E = E.isElement && "false" == E.node.getAttribute("contenteditable"));
							E && (L = !0, v = t[0].node, Q.setStartAt(v, CKEDITOR.POSITION_BEFORE_START),
						...
						for(ca = E.createBookmark(); P = C.zombies.pop();) P.getParent() && (U = E.clone(), U.moveToElementEditStart(P), U.removeEmptyBlocksAtEnd());
						if(R) for(; P = R.pop();) CKEDITOR.env.needsBrFiller ? P.appendBogus() : P.append(E.document.createText(" "));
						for(; P = C.mergeCandidates.pop();) P.mergeSiblings();
						CKEDITOR.env.webkit && E.startPath() && (P = E.startPath(), P.block ? P.block.$.normalize() : P.blockLimit && P.blockLimit.$.normalize());
						E.moveToBookmark(ca);
						if(!C.dontMoveCaret) {
							for(P = e(E); P && a(P) && !P.is(m.$empty);) {
								if(P.isBlockBoundary()) E.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END); else {
			...
			eol: {
				...
				rebuild: function(a, b) {
					...
					if(e.blockLimit.is({tr: 1, table: 1})) {
						...
						var p = e.contains(CKEDITOR.dtd.$list).getParent();
						f = function(a) {
							return !a.equals(p)
						}
					}
		...
		F = function() {
			...
			return {
				list: {
					...
					function a(c) {
						var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), r = {};
						f.guard = function(a, f) {
							if(a.type == CKEDITOR.NODE_ELEMENT) {
								var l = "visited_" + (f ? "out" : "in");
								if(a.getCustomData(l)) return;
								CKEDITOR.dom.element.setMarker(r, a, l, 1)
							}
							if(f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if(!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k,
								CKEDITOR.POSITION_AFTER_START), e.push(g); else {
								if(l = !f) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k));
								if(!l && (l = f)) if(a.is(d)) var l = h && h.getAscendant("table", !0), D = k && k.getAscendant("table", !0), I = a.getAscendant("table", !0),
									l = l && l.contains(I) || D && D.contains(I); else l = void 0;
					...
					return {
						detectPurge: function(a) {
							...
							var f = c(g, e.bookmark), h = f.clone(), k, n, l = f.getCommonAncestor();
	...
	(function() {
		...
		function e() {
			...
			if(b) {
				...
				if(!(e = !c) && (e = !c.isHidden())) {
					e = b;
					var g = c.getRanges(), f = e.getRanges(), h = g.length && g[0]._getTableElement() && g[0]._getTableElement().getAscendant("table", !0),
						k = f.length && f[0]._getTableElement() && f[0]._getTableElement().getAscendant("table", !0),
						l = 1 === g.length && g[0]._getTableElement() && g[0]._getTableElement().is("table"), N = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is("table");
		...
		function w(a, b) {
			...
			if(c) {
				if(!1 !== b) {
					var d = a.getDocument().getSelection().getNative(), e = d && "None" != d.type && d.getRangeAt(0), g = v.length;
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				var f = c.document, h = CKEDITOR.document, n = c.editable(), l = f.getBody(), r = f.getDocumentElement(), q = n.isInline(), D, u;
				...
				if(CKEDITOR.env.ie || CKEDITOR.env.gecko || q) m ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
					...
					CKEDITOR.env.gecko && !q && a || (c.lockSelection(u), D = 1)
							...
							r.on("mousedown", function(a) {
								function b(a) {
									...
									if(x) {
										...
										x.setEndPoint(0 > v.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
										x.select()
									}
								}
								...
								if(a.getTarget().is("html") && a.$.y < r.$.clientHeight &&
									...
									x = l.$.createTextRange();
									try {
										x.moveToPoint(a.$.clientX, a.$.clientY)
									} catch(d) {
									}
									v = x.duplicate();
									r.on("mousemove", b);
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.selection, {_removeFillingCharSequenceString: x, _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: v});
			...
			getNative: function() {
				...
				var a = m ? function() {
					...
					var b = function(b, c) {
						...
						if(-1 == r || r == e.length - 1 && 0 > q) {
							...
							h = h.text.replace(/(\r\n|\r)/g, "\n").length;
							e = d.childNodes;
							if(!h) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? {container: d, offset: e.length} : {container: g, offset: g.nodeValue.length};
				...
				var b = this, c = CKEDITOR.tools.tryThese(function() {
					...
					for(var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) &&
						c.type == CKEDITOR.NODE_ELEMENT && K[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
					return d && d.$
				});
				...
				if(a.length) if(this.isLocked) {
					...
					a:{
						var l, N;
						if(1 == a.length && !(N = a[0]).collapsed && (p = N.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (N = N.clone(), N.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = N.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
					...
					if(p) this.fake(p); else if(b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !E && !a[0]._getTableElement({table: 1}).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
						if(m) {
							...
							if((c = b.getEnclosedNode()) &&
								c.type == CKEDITOR.NODE_ELEMENT && c.getName() in K && (!c.is("a") || !c.getText())) try {
							...
							k ? (p =
								b.document.$.body.createTextRange(), p.moveToElementText(k.$), L.setEndPoint("EndToEnd", p), L.moveEnd("character", -1)) : (n = N.getNext(l), C = N.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(p)) && (C || !N.hasPrevious() || N.getPrevious().is && N.getPrevious().is("br")), C = b.document.createElement("span"), C.setHtml("\x26#65279;"), C.insertBefore(N), n && b.document.createText("﻿").insertBefore(N));
							b.setStartBefore(N);
							N.remove();
							a ? (n ? (L.moveStart("character", -1), L.select(), b.document.$.selection.clear()) : L.select(),
							...
							for(L = 0; L < a.length; L++) {
								...
								b.collapsed && CKEDITOR.env.webkit && q(b) && (p = g(this.root), b.insertNode(p), (n = p.getNext()) && !p.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (w(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
		...
		function b(c) {
			...
			if(c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
				var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, q = l || h.includeReadonly;
				null ==
				...
				c.trim();
				var r = c.createBookmark(), w = r.startNode, u = r.endNode, t = w, x;
				if(!l) {
					var v = c.getCommonAncestor(), l = a(w, v), v = a(u, v);
					l && (t = l.getNextSourceNode(!0));
					v && (u = v)
				}
				for(t.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
					l = !1;
					if(t.equals(u)) t = null, l = !0; else {
						var z = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null, v = z && "false" == t.getAttribute("contentEditable"), y = z &&
							-1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, z), y = z && (t.getAttribute("data-nostyle") || y);
						if(z && t.data("cke-bookmark") || t.type === CKEDITOR.NODE_COMMENT) {
							t = t.getNextSourceNode(!0);
							continue
						}
						if(v && q && CKEDITOR.dtd.$block[z]) for(var D = t, E = f(D), F = void 0, G = E.length, H = 0, D = G && new CKEDITOR.dom.range(D.getDocument()); H < G; ++H) {
							var F = E[H], J = CKEDITOR.filter.instances[F.data("cke-filter")];
							if(J ? J.check(this) : 1) D.selectNodeContents(F), b.call(this, D)
						}
						E = z ? !m[z] || y ? 0 : v && !q ? 0 : d(t, u, h, T) : 1;
						if(E) if(F =
							t.getParent(), E = h, G = g, H = k, !F || !(F.getDtd() || CKEDITOR.dtd.span)[G] && !H || E.parentRule && !E.parentRule(F)) l = !0; else {
							if(x || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(u) | T) != T || (x = c.clone(), x.setStartBefore(t)), z = t.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) {
								for(var z = t, K; (l = !z.getNext(B)) && (K = z.getParent(), m[K.getName()]) && d(K, w, h, O);) z = K;
								x.setEndAfter(z)
							}
						} else l = !0;
					...
					if(l && x && !x.collapsed) {
						for(var l = M(this, e), v = l.hasAttributes(), y = x.getCommonAncestor(),
								z = {}, E = {}, F = {}, G = {}, U, R, Y; l && y;) {
							if(y.getName() == g) {
								for(U in h.attributes) !G[U] && (Y = y.getAttribute(R)) && (l.getAttribute(U) == Y ? E[U] = 1 : G[U] = 1);
								for(R in h.styles) !F[R] && (Y = y.getStyle(R)) && (l.getStyle(R) == Y ? z[R] = 1 : F[R] = 1)
							}
							y = y.getParent()
						}
						...
						l ? (x.extractContents().appendTo(l), x.insertNode(l), A.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), x.extractContents().appendTo(l),
							x.insertNode(l), A.call(this, l), l.remove(!0));
						x = null
					}
				}
				c.moveToBookmark(r);
		...
		function c(a) {
			function b() {
				for(var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(q.getParent()), e = null, g = null, f = 0; f < a.elements.length; f++) {
					var h = a.elements[f];
			...
			if(a.collapsed) {
				...
				var q = c.endNode, m = this;
				b();
				for(g = d; !g.equals(q);) f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? z.call(this, g) : t(g, E(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
				(b(), f = d.getNext())), g = f
			}
			a.moveToBookmark(c);
		...
		function h(a) {
			...
			for(var d, e = a.document, g; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = M(this, e, d), q(d, g));
			a.moveToBookmark(b)
		}
		...
		function q(a, b) {
			...
			if(d && !e) {
				...
				b = e
			} else f ? b = x(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b);
			b.replace(a);
			if(d) {
				var c = b, k;
				(k = c.getPrevious(G)) &&
		...
		function z(a, b) {
			var c = this._.definition, d = c.attributes, c = c.styles, e = E(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f;
			for(f in d) if("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == u(f, d[f])) b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f));
			for(var h in c) this._.definition.fullMatch && a.getStyle(h) != u(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
			t(a, e, y[a.getName()]);
		...
		}, r = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, B = CKEDITOR.dom.walker.bookmark(0, 1), G = CKEDITOR.dom.walker.whitespaces(1);
		CKEDITOR.style = function(a, b) {
			...
			c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
				a.element : "*";
			this.type = a.type || (y[c] ? CKEDITOR.STYLE_BLOCK : K[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
	...
	CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
		attachStyleStateChange: function(a, d) {
			...
			b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function(a) {
				for(var d = 0; d < b.length; d++) {
					var e = b[d], k = e.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
					e.fn.call(this, k)
				}
			}));
			b.push({style: a, fn: d})
	...
	(function() {
		...
		CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
			...
			if(this.root.editor._.shiftPressed || this.isFake || b.isCollapsed || b.startContainer.equals(b.endContainer)) e = !1; else if(0 === b.endOffset) e = !0; else {
				...
				var k = b.endContainer.type === CKEDITOR.NODE_TEXT, h = e ? b.startContainer.getLength() : b.startContainer.getChildCount();
			...
			CKEDITOR.tools.createClass({
				$: function(a, b) {
					...
					initialColorCode: "", isValidColor: !0, type: 0, hue: 0, saturation: 0, lightness: 0, red: 0, green: 0, blue: 0, alpha: 1, blendAlphaColor: function(a, b, c, d) {
						...
						return {type: CKEDITOR.tools.color.TYPE_RGB, red: parseInt(a[1] + a[2], 16), green: parseInt(a[3] + a[4], 16), blue: parseInt(a[5] + a[6], 16), alpha: b}
						...
						var l = a(c[1], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE), q = a(c[2], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE), g = 1;
						...
						var f = 4 === c.length, l = a(c[0], CKEDITOR.tools.color.MAX_HUE_CHANNEL_VALUE), q = d(c[1], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
							g = d(c[2], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE), w = 1;
						b = this._.hslToRgb(l, q, g);
						f && (w = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE));
						b.push(w);
						c = {type: CKEDITOR.tools.color.TYPE_HSL, red: b[0], green: b[1], blue: b[2], alpha: b[3], hue: l, saturation: Math.round(100 * q), lightness: Math.round(100 * g)};
						...
						var c = a.match(b);
						if(!c) return null;
						var d = -1 === c[1].indexOf(",") ? /\s/ : ",", d = c[1].split(d), d = CKEDITOR.tools.array.reduce(d, function(a, b) {
						...
						var d = c / CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE, f = Math.max(a, b, d), g = Math.min(a, b, d);
						c = f - g;
						var w = 0;
						switch(f) {
							case a:
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
		type: CKEDITOR.NODE_TEXT, getLength: function() {
			...
			var d = this.$.parentNode, b = d.childNodes.length, c = this.getLength(), f = this.getDocument(), e = new CKEDITOR.dom.text(this.$.splitText(a), f);
			d.childNodes.length ==
	...
	(function() {
		function a(a, c, d) {
			var e = a.serializable, k = c[d ? "endContainer" : "startContainer"], h = d ? "endOffset" : "startOffset", l = e ? c.document.getById(a.startNode) : a.startNode;
...
*/
		...
		onLoad: function() {
				...
				labeledElement: function(b, a, d, f) {
					...
					if(!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "span", null, null, function() {
							var c = CKEDITOR.tools.extend({}, a, {id: a.id ? a.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0), e = [], d = CKEDITOR.tools.getNextId() + "_label",
					...
					if(!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
							for(var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < a.items.length; k++) {
								var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0], n = void 0 !== l[1] ? l[1] : l[0], p = CKEDITOR.tools.getNextId() + "_radio_input", q = p + "_label",
									p = CKEDITOR.tools.extend({}, a, {id: p, title: null, type: null}, !0), h = CKEDITOR.tools.extend({}, p, {title: h}, !0),
									r = {type: "radio", "class": "cke_dialog_ui_radio_input", name: g, value: n, "aria-labelledby": q}, u = [];
								c._["default"] ==
								n && (r.checked = "checked");
								t(p);
								t(h);
			...
			CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, q, {
				getInputElement: function() {
					...
					var a = this._, d = CKEDITOR.document.getById(a.frameId).getFrameDocument(), f = a.definition, c = a.buttons, e = this.formLoadedNumber, m = this.formUnloadNumber,
	...
	(function() {
		...
		function da(a) {
			function b(b) {
				var c = "rtl" == f.lang.dir, q = k.width, l = k.height, w = q + (b.data.$.screenX - m.x) * (c ? -1 : 1) * (a._.moved ? 1 : 2), A = l + (b.data.$.screenY - m.y) * (a._.moved ? 1 : 2),
					C = a._.element.getFirst(), C = c && parseInt(C.getComputedStyle("right"), 10), v = a.getPosition();
				v.x = v.x || 0;
				v.y = v.y || 0;
			...
			if(d != CKEDITOR.DIALOG_RESIZE_NONE) {
				var f = a.getParentEditor(), g, h, p, m, k, q, l = CKEDITOR.tools.addFunction(function(d) {
					...
					k = a.getSize();
					var f = a.parts.contents, l = f.$.getElementsByTagName("iframe").length, w = !(CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.quirks);
		...
		function P(a) {
			var b = a.config, c = CKEDITOR.skinName || a.config.skin, e = b.dialog_backgroundCoverColor || ("moono-lisa" == c ? "black" : "white"), c = b.dialog_backgroundCoverOpacity,
				d = b.baseFloatZIndex, b = CKEDITOR.tools.genKey(e, c, d), f = B[b];
		...
		CKEDITOR.dialog = function(a, b) {
			...
			var g = CKEDITOR.dialog._.dialogDefinitions[b], h = CKEDITOR.tools.clone(U), p = a.config.dialog_buttonsOrder || "OS", m = a.lang.dir, k = {}, q, l;
		...
		CKEDITOR.dialog.prototype = {
			destroy: function() {
				...
				var f = this.parts.dialog.getParent().getClientSize(), g = this.getSize(), h = this._.viewportRatio, p = Math.max(f.width - g.width, 0), f = Math.max(f.height - g.height, 0);
				...
				var a = this._.element, b = this.definition, c = CKEDITOR.document.getBody(), e = this._.editor.config.baseFloatZIndex;
				...
				if(this.state != a) {
					...
					if(a == CKEDITOR.DIALOG_STATE_BUSY) {
						if(!this.parts.spinner) {
							var b = this.getParentEditor().lang.dir, c = {attributes: {"class": "cke_dialog_spinner"}, styles: {"float": "rtl" == b ? "right" : "left"}};
		...
		(function() {
			CKEDITOR.ui.dialog = {
				uiElement: function(a, b, c, e, d, f, g) {
					if(!(4 > arguments.length)) {
						var h = (e.call ? e(b) : e) || "div", p = ["\x3c", h, " "], m = (d && d.call ? d(b) : d) || {}, k = (f && f.call ? f(b) : f) || {},
							q = (g && g.call ? g.call(this, a, b) : g) || "", l = this.domId = k.id || CKEDITOR.tools.getNextId() + "_uiElement";
	...
	(function() {
		function q(a, f, e, b) {
			if(!a.isReadOnly() && !a.equals(e.editable())) {
				...
				b = a;
				for(var c = e.editable(); (b = b.getParent()) && !b.equals(c);) if(b.getCustomData("bidi_processed")) {
		...
		function p(a) {
			return {
				...
				allowedContent: {"h1 h2 h3 h4 h5 h6 table ul ol blockquote div tr p div li td": {propertiesOnly: !0, attributes: "dir"}}, requiredContent: "p[dir]", refresh: function(a, e) {
					var b = a.config.useComputedState, c;
					if(!b) {
						c = e.lastElement;
					...
					var e = f.getSelection(), b = f.config.enterMode, c = e.getRanges();
					if(c && c.length) {
						for(var h = {}, d = e.createBookmarks(), c = c.createIterator(), g, l = 0; g = c.getNextRange(1);) {
							...
							k && q(k, a, f, h);
							var m = new CKEDITOR.dom.walker(g), n = d[l].startNode, p = d[l++].endNode;
		...
		function w(a) {
			var f = a == l.setAttribute, e = a == l.removeAttribute, b = /\bdirection\s*:\s*(.*?)\s*(:?$|;)/;
			return function(c, h) {
				if(!this.isReadOnly()) {
					var d;
		...
		CKEDITOR.plugins.add("bidi", {
			init: function(a) {
				function f(b, c, e,
					...
					a.ui.addButton && a.ui.addButton(b, {label: c, command: e, toolbar: "bidi," + f})
				}
	...
	(function() {
		...
		r.prototype = {
			add: function(b) {
				...
				var a = this.element, c = this.editor, d = c.ui.contentsElement.getClientRect(), e = c.ui.contentsElement.getDocumentPosition(), f, l, u = a.getClientRect(), m,
				...
				f && f.isVisible() && l.bottom > d.top && l.bottom < d.bottom - u.height ? a.setStyles({position: "fixed", top: k(l.bottom)}) : 0 < d.top ? a.setStyles({
					position: "absolute",
					top: k(e.y)
				}) : e.y + d.height - u.height > p.y ? a.setStyles({position: "fixed", top: 0}) : a.setStyles({position: "absolute", top: k(e.y + d.height - u.height)});
	...
	(function() {
		...
		var c = c + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" onclick\x3d"' + l + 'CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{style}"') +
			...
			v = CKEDITOR.addTemplate("buttonArrow", '\x3cspan class\x3d"cke_button_arrow"\x3e' + (CKEDITOR.env.hc ? "\x26#9660;" : "") + "\x3c/span\x3e"), w = CKEDITOR.addTemplate("button", c);
		...
		CKEDITOR.ui.button.prototype = {
			render: function(a, b) {
				...
				var p = null, q = CKEDITOR.env, r = this._.id = CKEDITOR.tools.getNextId(), g = "", d = this.command, l, m, k;
				this._.editor = a;
				var e = {
						...
						if(a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
							...
							a.addCommand("toolbarCollapse", {
								readOnly: 1, exec: function(b) {
									var a = b.ui.space("toolbar_collapser"), c = a.getPrevious(), d = b.ui.space("contents"), e = c.getParent(), h = parseInt(d.$.style.height, 10),
										g = e.$.offsetHeight, f = a.hasClass("cke_toolbox_collapser_min");
	...
	(function() {
			...
			function d() {
				return {
					...
					async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function(a, b) {
						...
						var d = this, k = "undefined" !== typeof b.notification ? b.notification : !0, h = b.type, f = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard,
		...
		function D(a) {
			...
			a.on("contentDom", function() {
				...
				var f = a.editable(), l = CKEDITOR.plugins.clipboard.getDropTarget(a), k = a.ui.space("top"), r = a.ui.space("bottom");
		...
		CKEDITOR.plugins.add("clipboard", {
			requires: "dialog,notification,toolbar", init: function(a) {
				...
				a.on("paste", function(b) {
					b = b.data;
					var c = a._.nextPasteType || b.type, d = b.dataValue, f, g = a.config.clipboard_defaultContentType || "html",
						l = b.dataTransfer.getTransferType(a) == CKEDITOR.DATA_TRANSFER_EXTERNAL, n = !0 === a.config.forcePasteAsPlainText;
		...
		CKEDITOR.plugins.clipboard = {
			...
			getRangeAtDropPosition: function(a, b) {
				var c = a.data.$, d = c.clientX, e = c.clientY, g = b.getSelection(!0).getRanges()[0], f = b.createRange();
			...
			CKEDITOR.ui.panelButton = CKEDITOR.tools.createClass({
				base: CKEDITOR.ui.button, $: function(c) {
					...
					createPanel: function(c) {
						var b = this._;
						if(!b.panel) {
							var f = this._.panelDefinition, e = this._.panelDefinition.block, h = f.parent || CKEDITOR.document.getBody(), d = this._.panel = new CKEDITOR.ui.floatPanel(c, h, f),
								f = d.addBlock(b.id, e), a = this, g = c.getCommand(this.command);
							d.onShow = function() {
	...
	(function() {
		...
		CKEDITOR.ui.panel.prototype = {
			render: function(a, b) {
				var e = {editorId: a.id, id: this.id, langCode: a.langCode, dir: a.lang.dir, cls: this.className, frame: "", env: CKEDITOR.env.cssClass, "z-index": a.config.baseFloatZIndex + 1};
				this.getHolderElement = function() {
					...
					if(!a) {
						if(this.isFramed) {
							...
							a.write(k.output(CKEDITOR.tools.extend({css: CKEDITOR.tools.buildStyleHtml(this.css), onload: "window.parent.CKEDITOR.tools.callFunction(" + b + ");"}, e)));
		...
		CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
			$: function(a, b, c, m) {
				...
				addBlock: function(a, b) {
					...
					var k = this.element, e = this._.iframe, e = CKEDITOR.env.ie && !CKEDITOR.env.edge ? e : new CKEDITOR.dom.window(e.$.contentWindow), f = k.getDocument(),
						r = this._.parentElement.getPositionedAncestor(), t = b.getDocumentPosition(f), f = r ? r.getDocumentPosition(f) : {x: 0, y: 0}, q = "rtl" == this._.dir,
					...
					CKEDITOR.tools.setTimeout(function() {
						var a = CKEDITOR.tools.bind(function() {
							...
							a.removeStyle("width");
							if(l.autoSize) {
								var b = l.element.getDocument(), b = (CKEDITOR.env.webkit || CKEDITOR.env.edge ? l.element : b.getBody()).$.scrollWidth;
							...
							var b = n.element.getWindow(), a = k.$.getBoundingClientRect(), b = b.getViewPaneSize(), c = a.width || a.right - a.left, e = a.height || a.bottom - a.top,
		...
		CKEDITOR.plugins.add("colorbutton", {
			requires: "panelbutton,floatpanel", init: function(a) {
				function b(d) {
					...
					var A = new CKEDITOR.style(r["colorButton_" + h + "Style"]), q = CKEDITOR.tools.getNextId() + "_colorBox", x = {type: h},
					...
					a.ui.add(g, CKEDITOR.UI_PANELBUTTON, {
						...
						onOpen: function() {
							var d = a.getSelection(),
								b = d && d.getStartElement(), e = a.elementPath(b), c = "back" == h ? "background-color" : "color";
							if(e) {
				...
				function c(b, c, f) {
					var g = [], h = r.colorButton_colors.split(","), k = a.plugins.colordialog && r.colorButton_enableMore;
					f = h.length + f + (k ? 1 : 0);
					var v = 1;
					...
					for(b = 0; b < h.length; b++) {
						...
						var m = h[b].split("/"), q = m[0], m = new n(a, {color: m[1] || q, label: m[1] ? q : void 0}, c);
	...
	(function() {
		CKEDITOR.plugins.add("templates", {
			requires: "dialog,ajax", init: function(a) {
	...
	(function() {
		...
		CKEDITOR.menu = CKEDITOR.tools.createClass({
			$: function(a, b) {
				...
				onShow: function() {
					var a = this.editor.getSelection(), b = a && a.getStartElement(), f = this.editor.elementPath(), c = this._.listeners;
					this.removeAll();
		...
		CKEDITOR.menuItem = CKEDITOR.tools.createClass({
			$: function(a, b, c) {
				...
				render: function(a, b, f) {
					var k = a.id + String(b), h = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state, l = "", g = this.editor, e, d,
						m = h == CKEDITOR.TRISTATE_ON ? "on" : h == CKEDITOR.TRISTATE_DISABLED ?
							"disabled" : "off";
					this.role in {menuitemcheckbox: 1, menuitemradio: 1} && (l = ' aria-checked\x3d"' + (h == CKEDITOR.TRISTATE_ON ? "true" : "false") + '"');
					var n = this.getItems, t = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", q = this.name;
		...
		requires: "menu", onLoad: function() {
			CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({
				base: CKEDITOR.menu, $: function(a) {
					this.base.call(this, a, {panel: {css: a.config.contextmenu_contentsCss, className: "cke_menu_panel", attributes: {"aria-label": a.lang.contextmenu.options}}})
				}, proto: {
						...
						a.on("contextmenu", function(a) {
							...
							if(!f || !b) if(a.preventDefault(),
								...
								if(CKEDITOR.env.mac && CKEDITOR.env.webkit) {
									var b = this.editor, c = (new CKEDITOR.dom.elementPath(a.getTarget(), b.editable())).contains(function(a) {
										return a.hasAttribute("contenteditable")
									}, !0);
									c && "false" == c.getAttribute("contenteditable") && b.getSelection().fake(c)
								}
								var c = a.getTarget().getDocument(), g = a.getTarget().getDocument().getDocumentElement(), b = !c.equals(CKEDITOR.document), c = c.getWindow().getScrollPosition(),
									h = b ? a.$.clientX : a.$.pageX || c.x + a.$.clientX, k = b ? a.$.clientY : a.$.pageY || c.y + a.$.clientY;
								CKEDITOR.tools.setTimeout(function() {
			...
			a.addCommand("contextMenu", {
				exec: function(a) {
					var d = 0, e = 0, b = a.getSelection().getRanges(), b = b[b.length - 1].getClientRects(a.editable().isInline());
	...
	(function() {
		...
		CKEDITOR.plugins.copyformatting = {
			...
			commands: {
				copyFormatting: {
					exec: function(a, b) {
						var e = CKEDITOR.plugins.copyformatting, d = a.copyFormatting, c = b ? "keystrokeHandler" == b.from : !1, f = b ? b.sticky || c : !1, g = e._getCursorContainer(a),
				...
				applyFormatting: {
					editorFocus: CKEDITOR.env.ie && !CKEDITOR.env.edge ? !1 : !0, exec: function(a, b) {
						var e = a.getCommand("copyFormatting"), d = b ? "keystrokeHandler" == b.from : !1, c = CKEDITOR.plugins.copyformatting, f = a.copyFormatting, g = c._getCursorContainer(a),
							h = CKEDITOR.document.getDocumentElement();
			...
			_applyStylesToListContext: function(a, b, e) {
				var d, c, f;
				for(f = 0; f < e.length; f++) d = e[f], c = b.createBookmark(), "ol" === d.element || "ul" === d.element ? k(b, {ul: 1, ol: 1}, function(a) {
					var b = d;
		...
		CKEDITOR.plugins.enterkey =
			{
				enterBlock: function(a, e, b, l) {
					...
					if(b = b || y(a)) {
						b = z(b);
						var g = b.document, f = b.checkStartOfBlock(), k = b.checkEndOfBlock(), p = a.elementPath(b.startContainer), c = p.block, m = e == CKEDITOR.ENTER_DIV ? "div" : "p", d;
						if(c && f && k) {
							f = c.getParent();
							...
							if(c.is("li") || c.getParent().is("li")) {
								...
								var h = !c.hasNext();
								l = a.getSelection();
								var m = l.createBookmarks(), t = c.getDirection(1), k = c.getAttribute("class"), q = c.getAttribute("style"), r = d.getDirection(1) != t;
					...
					if(b = b || y(a)) {
						var n = b.document, g = b.checkEndOfBlock(), f = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), k = f.block, p = k && f.block.getName();
	...
	(function(d) {
		...
		c.r = function(a) {
			typeof Symbol !== a0_0x5dec("0xb") && Symbol[a0_0x5dec("0x1a")] && Object.defineProperty(a, Symbol[a0_0x5dec("0x1a")], {value: a0_0x5dec("0x9")});
		...
		c.t = function(a, b) {
			...
			if(b & 2 && typeof a != a0_0x5dec("0x5b")) for(var d in a) c.d(e, d, function(b) {
				return a[b]
		...
		(function() {
			CKEDITOR[a0_0x5dec("0x46")][a0_0x5dec("0x31")](a0_0x5dec("0x29"), {
				lang: "en", icons: a0_0x5dec("0x29"), hidpi: !0, isSupportedEnvironment: function() {
					return !CKEDITOR[a0_0x5dec("0x15")].ie || 10 < CKEDITOR.env.version
				}, beforeInit: function(a) {
					var c = a[a0_0x5dec("0x17")].exportPdf_tokenUrl, b = this[a0_0x5dec("0x4f")](a, c);
					b[a0_0x5dec("0x43")]();
					a.on("exportPdf",
						function(a) {
					...
					if(this[a0_0x5dec("0x6")]() && (a[a0_0x5dec("0x1c")]("exportPdf", {
						exec: function(f) {
							var k = c(f[a0_0x5dec("0x4c")][a0_0x5dec("0x29")][a0_0x5dec("0x6e")],
								"progress", 0), h = {html: f[a0_0x5dec("0x0")](), css: b(f[a0_0x5dec("0x40")]), options: f.config.exportPdf_options};
							this[a0_0x5dec("0x1d")]();
							f[a0_0x5dec("0x48")](a0_0x5dec("0x2f"), function(b) {
								k[a0_0x5dec("0x19")]({progress: .2});
								b.data[a0_0x5dec("0x4")] = e(b[a0_0x5dec("0x50")][a0_0x5dec("0x4")]);
								var c = b.data, d = a0_0x5dec("0x4");
							...
							f[a0_0x5dec("0x48")](a0_0x5dec("0x2f"), function(b) {
								...
								var e = new XMLHttpRequest, h = a[a0_0x5dec("0x17")][a0_0x5dec("0x35")] || "cke4";
								e[a0_0x5dec("0x34")](a0_0x5dec("0x26"), g);
								e.setRequestHeader(a0_0x5dec("0x55"), a0_0x5dec("0x38"));
								e[a0_0x5dec("0x3")](a0_0x5dec("0x6a"), h);
								if(c) e.setRequestHeader("Authorization", c); else CKEDITOR[a0_0x5dec("0x27")](a0_0x5dec("0x5f"));
								e[a0_0x5dec("0xe")] = a0_0x5dec("0x45");
								e[a0_0x5dec("0x5")](b);
								k[a0_0x5dec("0x19")]({progress: .5});
								d(e, k)
							}, null, null, 20);
	...
	(function() {
		...
		function q() {
			...
			var d = b.config["filebrowser" + k(a.getName()) + "WindowWidth"] || b.config.filebrowserWindowWidth ||
				"80%", a = b.config["filebrowser" + k(a.getName()) + "WindowHeight"] || b.config.filebrowserWindowHeight || "70%", c = this.filebrowser.params || {};
			c.CKEditor = b.name;
		...
		function l(a, b, d, c) {
			if(c &&
				...
				e.onClick = function(b) {
					var c = b.sender, d = c.getDialog().getContentElement(this["for"][0], this["for"][1]).getInputElement(), e = CKEDITOR.fileTools && CKEDITOR.fileTools.isFileUploadSupported;
		...
		function m(a, b) {
			var d = this._.filebrowserSe.getDialog(), c = this._.filebrowserSe["for"], e = this._.filebrowserSe.filebrowser.onSelect;
	...
	CKEDITOR.plugins.add("find", {
		requires: "dialog", init: function(a) {
			var b = a.addCommand("find", new CKEDITOR.dialogCommand("find")), c = a.addCommand("replace", new CKEDITOR.dialogCommand("find", {tabId: "replace"}));
			b.canUndo = !1;
			b.readOnly = 1;
			c.canUndo = !1;
	...
	(function() {
		...
		var e = e + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event,this);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" onclick\x3d"' + h + 'CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan id\x3d"{id}_text" class\x3d"cke_combo_text cke_combo_inlinelabel"\x3e{label}\x3c/span\x3e\x3cspan class\x3d"cke_combo_open"\x3e\x3cspan class\x3d"cke_combo_arrow"\x3e' +
			(CKEDITOR.env.hc ? "\x26#9660;" : CKEDITOR.env.air ? "\x26nbsp;" : "") + "\x3c/span\x3e\x3c/span\x3e\x3c/a\x3e\x3c/span\x3e"), m = CKEDITOR.addTemplate("combo", e);
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
			$: function(a) {
				...
				renderHtml: function(a) {
					...
					if(!this._.panel) {
						var b = this._.panelDefinition, c = this._.panelDefinition.block, e = b.parent || CKEDITOR.document.getBody(), g = "cke_combopanel__" + this.name,
				...
				hideGroup: function(a) {
					...
					if(!CKEDITOR.tools.isEmpty(this._.items)) for(var b in this._.items) if(a({value: b, text: this._.items[b]})) {
						this.setValue(b);
						break
					}
				}
	...
	(function() {
		function k(a, b) {
			var c = a.config, e = b.lang, d = new CKEDITOR.style(b.styleDefinition), f = new l({entries: b.entries, styleVariable: b.styleVariable, styleDefinition: b.styleDefinition}), g;
			a.addCommand(b.commandName, {
				exec: function(a, b) {
					var c = b.newStyle, d = b.oldStyle, e = a.getSelection().getRanges()[0], f = void 0 === c;
					if(d || c) d && e.collapsed && m({editor: a, range: e, style: d}), f ? a.removeStyle(d) : (d && !n(d, c) && a.removeStyle(d), a.applyStyle(c))
			...
			a.ui.addRichCombo(b.comboName, {
				...
				panel: {css: [CKEDITOR.skin.getPath("editor")].concat(c.contentsCss), multiSelect: !1, attributes: {"aria-label": e.panelTitle}},
				init: function() {
	...
	(function() {
		...
		function l(b, a) {
			...
			}), n = b.activeFilter, f = new CKEDITOR.htmlParser.basicWriter, g = CKEDITOR.htmlParser.fragment.fromHtml(a);
			e.applyTo(g);
			n.applyTo(g);
			CKEDITOR.tools.array.forEach(c, function(a) {
				a.name = "cke:" + a.name
		...
		CKEDITOR.editor.prototype.createFakeElement = function(b, a, c, d) {
			...
			a = {"class": a, "data-cke-realelement": encodeURIComponent(b.getOuterHtml()), "data-cke-real-node-type": b.type, alt: e, title: e, align: b.getAttribute("align") || ""};
			CKEDITOR.env.hc ||
		...
		CKEDITOR.editor.prototype.restoreRealElement = function(b) {
			...
			var a = decodeURIComponent(b.data("cke-realelement")), a = l(this, a), a = CKEDITOR.dom.element.createFromHtml(a, this.document);
		...
		requires: "dialog,fakeobjects", onLoad: function() {
			...
			var a = b.lang,
				...
				d = function(f, c, d) {
					...
					b.ui.addButton && b.ui.addButton(f, {label: a.common[f.charAt(0).toLowerCase() + f.slice(1)], command: c, toolbar: "forms," + (g += 10)});
	...
	(function() {
		CKEDITOR.plugins.add("iframe", {
			requires: "dialog,fakeobjects", onLoad: function() {
				...
				var b = a.lang.iframe, c = "iframe[align,longdesc,tabindex,frameborder,height,name,scrolling,src,title,width]";
		...
		CKEDITOR.plugins.add("wysiwygarea", {
			init: function(a) {
				...
				a.addMode("wysiwyg", function(d) {
					function b(b) {
						b && b.removeListener();
						if(!a.isDestroyed() && !a.isDetached() && (a.editable(new l(a, g.getFrameDocument().getBody())), a.setData(a.getData(1), d), t)) {
					...
					function e() {
						m = new MutationObserver(function(b) {
							for(var c = 0; c < b.length; c++) {
								var d = b[c];
								if("childList" === d.type && 0 !==
									d.addedNodes.length) for(var e = 0; e < d.addedNodes.length; e++) {
					...
					if(r) g.on("load", b);
					var k = a.title, n = a.fire("ariaEditorHelpLabel",
						{}).label, p = !1, u = CKEDITOR.env.ie && 11 === CKEDITOR.env.version, t = !!window.MutationObserver, m;
					k && (CKEDITOR.env.ie && n && (k += ", " + n), g.setAttribute("title", k));
					if(n) {
						var k = CKEDITOR.tools.getNextId(), q = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + k + '" class\x3d"cke_voice_label"\x3e' + n + "\x3c/span\x3e");
						h.append(q, 1);
			...
			$: function() {
				...
				setData: function(a, d) {
					...
					if(d) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady"); else {
						...
						b._.dataStore = {id: 1};
						var c = b.config, e = c.fullPage, f = c.docType, h = CKEDITOR.tools.buildStyleHtml(x()).replace(/<style>/, '\x3cstyle data-cke-temp\x3d"1"\x3e');
						...
						e ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), g && (a = a.replace(/<head[^>]*?>/, "$\x26" + g)), a = a.replace(/<\/head\s*>/, h + "$\x26"), a = f + a) : a = c.docType + '\x3chtml dir\x3d"' + c.contentsLangDirection +
							'" lang\x3d"' + (c.contentsLanguage || b.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + g + h + "\x3c/head\x3e\x3cbody" + (c.bodyId ? ' id\x3d"' + c.bodyId + '"' : "") + (c.bodyClass ? ' class\x3d"' + c.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
					...
					a = this.editor;
					var d = a.config, b = d.fullPage, c = b && a.docType, e = b && a.xmlDeclaration,
			...
			init: function(a) {
				if(!a.blockless) {
					var c = new h(a, "justifyleft", "left"), b = new h(a, "justifycenter", "center"), f = new h(a,
						"justifyright", "right"), d = new h(a, "justifyblock", "justify");
					...
					a.ui.addButton && (a.ui.addButton("JustifyLeft", {
						...
						command: "justifyleft",
						toolbar: "align,10"
					}), a.ui.addButton("JustifyCenter", {label: a.lang.common.center, command: "justifycenter", toolbar: "align,20"}), a.ui.addButton("JustifyRight", {
	...
	(function() {
		...
		CKEDITOR.plugins.add("link", {
			requires: "dialog,fakeobjects", onLoad: function() {
				...
				}), c.ui.addButton("Unlink", {label: c.lang.link.unlink, command: "unlink", toolbar: "links,20"}), c.ui.addButton("Anchor", {
		...
		var t = /^javascript:/, u = /^(?:mailto)(?:(?!\?(subject|body)=).)+/i,
			v = /subject=([^;?:@&=$,\/]*)/i, w = /body=([^;?:@&=$,\/]*)/i, x = /^#(.*)$/, y = /^((?:http|https|ftp|news):\/\/)?(.*)$/, z = /^(_(?:self|top|parent|blank))$/,
			A = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/, B = /^javascript:([^(]+)\(([^)]+)\)$/,
			C = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/, D = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, E = /^tel:(.*)$/, m = {
		...
		CKEDITOR.plugins.link = {
			getSelectedLink: function(c, b) {
				...
				for(f = 0; d = a.getItem(f++);) (d = this.tryRestoreFakeAnchor(c, d)) && e.push({name: d.getAttribute("name"), id: d.getAttribute("id")});
				return e
				...
				var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "", e = c.plugins.link.compiledProtectionFunction, f = c.config.emailProtection, d = {}, g;
				...
				if(b) {
					if(a = b.getAttribute("target")) d.target = {
						...
						type: "popup",
						name: a[1]
					}; f = D.exec(a[2]);) "yes" != f[2] && "1" != f[2] || f[1] in {height: 1, width: 1, top: 1, left: 1} ? isFinite(f[2]) && (d.target[f[1]] = f[2]) : d.target[f[1]] = !0;
					null !==
				...
				return {set: e, removed: CKEDITOR.tools.object.keys(l)}
												   ...
												   b) {
				var a = {img: 1, table: 1, tbody: 1, thead: 1, tfoot: 1, input: 1, select: 1, textarea: 1}, e = b.getSelection();
			...
			exec: function(c) {
				if(CKEDITOR.env.ie) {
					var b = c.getSelection().getRanges()[0],
						a = b.getPreviousEditableNode() && b.getPreviousEditableNode().getAscendant("a", !0) || b.getNextEditableNode() && b.getNextEditableNode().getAscendant("a", !0), e;
					b.collapsed && a &&
	...
	(function() {
		...
		function L(a, l, d) {
			...
			for(var h, k, b = 0; b < f.length; b++) for(var c = f[b], p; p = c.getParent();) {
				if(p.equals(l)) {
					g.push(c);
		...
		function N(a, l, d) {
			...
			var k = CKEDITOR.plugins.list.arrayToList(e, d, null, a.config.enterMode, l.root.getAttribute("dir")).listNode, c, p;
			f(!0);
			f();
			k.replace(l.root);
			a.fire("contentDomInvalidated")
		...
		function D(a, l, d) {
			...
			l.trim(!1, !0);
			var e = l.createBookmark(), g = new CKEDITOR.dom.elementPath(l.startContainer), b = g.block, g = g.lastElement.getAscendant("li", 1) || b,
				h = new CKEDITOR.dom.elementPath(d.startContainer), k = h.contains(CKEDITOR.dtd.$listItem),
				...
				for(var g, b = a[d].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(b), k = null, c = d, p = Math.max(a[d].indent, 0), m =
					...
					CKEDITOR.env.needsNbspFiller && 7 >= b.$.documentMode && m.append(b.createText(" ")), m.append(c.listNode), c = c.nextIndex; else if(-1 == q.indent && !d && g) {
						...
						var k = g.getDirection(1) != n, w = q.element, B = w.getAttribute("class"), E = w.getAttribute("style"),
							J = m.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (f != CKEDITOR.ENTER_BR || k || E || B), v, z = q.contents.length, x;
	...
	(function() {
		...
		function la(a) {
			var c = a.doc, d = G('\x3cspan contenteditable\x3d"false" data-cke-magic-line\x3d"1" style\x3d"' + Q + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e',
				c), b = CKEDITOR.getUrl(this.path + "images/" + (t.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") + ".png");
			v(d, {
				attach: function() {
		...
		function N(a, c) {
			...
			if(!(!c && d && d.date > new Date - ga)) {
				...
				v(a.view, {
					scroll: {x: d.x, y: d.y, width: a.doc.$.documentElement.scrollWidth - b.width, height: a.doc.$.documentElement.scrollHeight - b.height},
		...
		var v = CKEDITOR.tools.extend, R = CKEDITOR.dom.element, G = R.createFromHtml, t = CKEDITOR.env, ja = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, B = CKEDITOR.dtd, K = {}, I = 128, da = 64,
			T = 32, M = 16, C = 4, D = 2, x = 1, J = " ", fa = B.$listItem, oa = B.$tableContent, ma = v({}, B.$nonEditable, B.$empty), Z = B.$block, ga = 100,
		...
		CKEDITOR.plugins.add("maximize", {
			init: function(a) {
				...
				if(a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
					...
					if(a.config.maximize_historyIntegration) c.on(a.config.maximize_historyIntegration === CKEDITOR.HISTORY_NATIVE ? "popstate" : "hashchange", function() {
						var b = a.getCommand("maximize");
	...
	(function() {
		...
		CKEDITOR.plugins.add("pagebreak", {
			requires: "fakeobjects", onLoad: function() {
				...
				var b = a.dataProcessor, g = b && b.dataFilter, b = b && b.htmlFilter, h = /page-break-after\s*:\s*always/i, k = /display\s*:\s*none/i;
				b && b.addRules({
					attributes: {
						"class": function(a, c) {
	...
	(function() {
		var f = {
			canUndo: !1, async: !0, exec: function(a, b) {
				var c = a.lang, e = CKEDITOR.tools.keystrokeToString(c.common.keyboard, a.getCommandKeystroke(CKEDITOR.env.ie ? a.commands.paste : this)),
		...
		CKEDITOR.plugins.add("pastetext",
			{
				requires: "clipboard", init: function(a) {
					...
					CKEDITOR.plugins.clipboard.addPasteButton(a, "PasteText", {label: a.lang.pastetext.button, command: "pastetext", toolbar: "clipboard,40"});
		...
		CKEDITOR.plugins.add("pastefromgdocs", {
			requires: "pastetools", init: function(a) {
				...
				a.pasteTools.register({
					filters: [CKEDITOR.getUrl(c + "filter/common.js"), CKEDITOR.getUrl(d + "filter/default.js")], canHandle: function(a) {
				...
				if(this.isSupportedEnvironment()) {
					...
					b.pasteTools.register({
						priority: 100, filters: [CKEDITOR.getUrl(d + "filter/common.js"), CKEDITOR.getUrl(d + "filter/image.js"), CKEDITOR.getUrl(f + "filter/default.js")], canHandle: function(a) {
							...
							var c = a.data, e = c.dataValue || CKEDITOR.plugins.pastetools.getClipboardData(c, "text/html");
							c.dontFilter = !0;
	...
	(function() {
		CKEDITOR.plugins.add("pastefromword", {
			requires: "pastetools", init: function(a) {
				var f = 0, e = CKEDITOR.plugins.getPath("pastetools"), h = this.path, k = void 0 === a.config.pasteFromWord_inlineImages ? !0 : a.config.pasteFromWord_inlineImages,
				...
				a.pasteTools.register({
					filters: a.config.pasteFromWordCleanupFile ? [a.config.pasteFromWordCleanupFile] : e, canHandle: function(a) {
						...
						var b = CKEDITOR.plugins.pastetools.getContentGeneratorName(a), d = /(class="?Mso|style=["'][^"]*?\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/, b = b ? "microsoft" ===
							b : d.test(a);
						return a && (f || b)
					}, handle: function(e, b) {
						var d = e.data, c = CKEDITOR.plugins.pastetools.getClipboardData(d, "text/html"), g = CKEDITOR.plugins.pastetools.getClipboardData(d, "text/rtf"),
	...
	(function() {
		function k(a, f) {
			var g = CKEDITOR.plugins.getPath("preview"), b = a.config, e = a.title, h = function() {
				var a = location.origin, c = location.pathname;
			...
			return b.fullPage ? a.getData().replace(/<head>/, "$\x26" + h).replace(/[^>]*(?=<\/title>)/, "$\x26 \x26mdash; " + e) : b.docType + '\x3chtml dir\x3d"' +
				b.contentsLangDirection + '"\x3e\x3chead\x3e' + h + "\x3ctitle\x3e" + e + "\x3c/title\x3e" + CKEDITOR.tools.buildStyleHtml(b.contentsCss) + '\x3clink rel\x3d"stylesheet" media\x3d"screen" href\x3d"' + g + 'styles/screen.css"\x3e\x3c/head\x3e' + function() {
					var b = "\x3cbody\x3e", c = a.document && a.document.getBody();
					if(!c) return b;
		...
		function l() {
			var a = window.screen;
			return {width: Math.round(.8 * a.width), height: Math.round(.7 * a.height), left: Math.round(.1 * a.width)}
		}
		...
		CKEDITOR.plugins.add("preview", {
			init: function(a) {
				a.addCommand("preview", {
					modes: {wysiwyg: 1},
					canUndo: !1, readOnly: 1, exec: function() {
	...
	CKEDITOR.plugins.add("scayt", {
		requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function(a) {
			...
			a.on("reloadMarkupScayt", function(b) {
				var d = b.data && b.data.removeOptions, e = b.data && b.data.timeout, f = b.data && b.data.language, h = a.scayt;
			...
			if(a.config.scayt_disableOptionsStorage) {
				var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ?
					...
					f = ["lang", "ignore-all-caps-words", "ignore-domain-names", "ignore-words-with-mixed-cases", "ignore-words-with-numbers"], g = CKEDITOR.tools.search, k = CKEDITOR.tools.indexOf;
			...
			var c = CKEDITOR.plugins.scayt, d = a.dataProcessor, b = d && d.htmlFilter, e = a._.elementsPath && a._.elementsPath.filters, d = d && d.dataFilter, f = a.addRemoveFormatFilter,
				g = function(b) {
			...
			if(0 < c.length && "no_any_suggestions" !== c[0]) if(d) for(d = 0; d < c.length; d++) {
				...
				d < a.config.scayt_maxSuggestions ? (a.addMenuItem(l, {label: c[d], command: l, group: "scayt_suggest", order: d + 1}), b[l] = CKEDITOR.TRISTATE_OFF) : (a.addMenuItem(l, {
					label: c[d],
					command: l,
				...
				{label: k.getLocal("btn_noSuggestions") || "no_scayt_suggest", command: "no_scayt_suggest", group: "scayt_suggest", order: 0});
			return b
		}, menuGenerator: function(a, c) {
			var d = a.scayt, b = this.scaytMenuDefinition(a), e = {}, f = a.config.scayt_contextCommands.split("|"), g = c.getAttribute(d.getLangAttribute()) || d.getLang(), k, l, m, n;
			l = d.isScaytNode(c);
			m = d.isGraytNode(c);
		...
		CKEDITOR.plugins.add("stylescombo", {
			requires: "richcombo", init: function(c) {
				...
				c.ui.addRichCombo("Styles", {
					...
					toolbar: "styles,10",
					allowedContent: m,
					panel: {css: [CKEDITOR.skin.getPath("editor")].concat(l.contentsCss), multiSelect: !0, attributes: {"aria-label": h.panelTitle}},
					init: function() {
						var a,
							b, c, d, g, e;
						g = 0;
	...
	(function() {
		function q(d, f) {
			...
			for(var a = d.getRanges(), k = 0; k < a.length; k++) {
				var g = a[k];
				if(g.collapsed) (g = g.getCommonAncestor().getAscendant({td: 1, th: 1}, !0)) && b(g) && e.push(g); else {
		...
		function B(d) {
			if(d instanceof CKEDITOR.dom.selection) {
				var f = d.getRanges(), b = q(d), c = b[0].getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c),
					h = b[0].getParent().$.rowIndex, b = b[b.length - 1], a = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = [];
				d.reset();
				for(d = h; d <= a; d++) {
		...
		function y(d) {
			...
			var b = d.getRanges(), c = q(d), e = c[0], h = c[c.length - 1], c = e.getAscendant("table"), a = CKEDITOR.tools.buildTableMap(c), k, g, m =
				[];
			d.reset();
			var l = 0;
		...
		function x(d, f, b) {
			...
			var h = CKEDITOR.tools.buildTableMap(e), a = h.length, k = h[0].length, g = d.getParent().$.rowIndex, m = A(h, g, d), l;
			if(f) {
				var n;
				try {
			...
			for(f = 0; f < c.length; f++) {
				l = c[f];
				var t = l.getParent(), y = l.getFirst(), v = l.$.colSpan, z = l.$.rowSpan, t = t.$.rowIndex, B = A(h, t, l), w = w + v * z, p = Math.max(p, B - m + v);
				n = Math.max(n, t - g + z);
		...
		function C(d, f) {
			...
			if(f) return !0;
			var b = b[0], c = b.getParent(), e = c.getAscendant("table"), h = CKEDITOR.tools.buildTableMap(e), a = c.$.rowIndex, k = A(h, a, b), g = b.$.rowSpan, m;
			if(1 < g) {
				m = Math.ceil(g / 2);
				for(var g =
		...
		function E(d, f) {
			...
			if(1 < b.length) return !1;
			if(f) return !0;
			var b = b[0], c = b.getParent(), e = c.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(e), h = A(e, c.$.rowIndex, b), a = b.$.colSpan;
	...
	(function() {
		...
		function z(a, b) {
			var c = a.getAscendant("table"), d = b.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c), g = r(a), k = r(b), h = [], f = {}, l, p;
		...
		function A(a, b) {
			var c = a.editable().find(".cke_table-faked-selection"), d = a.editable().findOne("[data-cke-table-faked-selection-table]"), e;
			a.fire("lockSnapshot");
		...
		function w(a) {
			...
			if(a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
				var e = a.editor || a.listenerData.editor, g = e.getSelection(1), k = I(e), h = a.data.getTarget(), f = h && h.getAscendant({td: 1, th: 1}, !0), h = h && h.getAscendant("table", !0),
		...
		function M(a) {
			...
			m.active = !1;
			b && b.hasAttribute("data-cke-tableselection-ignored") || (a = a.data.getTarget().getAscendant({td: 1, th: 1}, !0), !a || a.hasClass("cke_table-faked-selection"))
		}
		...
		function N(a,
			...
			var d = a.getSelection(), e = d.createBookmarks(), g = a.document, k = a.createRange(), h = g.getDocumentElement().$, f = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
				l = a.blockless || CKEDITOR.env.ie ? "span" : "div", p, x, n, m;
			g.getById("cke_table_copybin") || (p = g.createElement(l), x = g.createElement(l), x.setAttributes({id: "cke_table_copybin", "data-cke-temp": "1"}), p.setStyles({
				position: "absolute",
				width: "1px",
				height: "1px",
				overflow: "hidden"
		...
		var H = {
			onPaste: function(a) {
				...
				var d = a.editor, e = d.getSelection(), g = v(e), k = e.isInTable(!0) && this.isBoundarySelection(e), h = this.findTableInPastedContent(d, a.data.dataValue), f, l;
				(function(a, b, d, c) {
					a = a.getRanges();
				...
				for(l = 0; l < c.length; l++) for(h = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++) if(f = new CKEDITOR.dom.element(c[l][p]), d = b[l] &&
		...
		CKEDITOR.plugins.tableselection =
			{
				getCellsBetween: z, keyboardIntegration: function(a) {
					...
					c.attachListener(c, "keydown", function(a) {
						...
						var g = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1, 13: 1}, k = CKEDITOR.tools.extend({table: 1}, CKEDITOR.dtd.$tableContent);
						delete k.td;
						delete k.th;
						return function(h) {
		...
		CKEDITOR.plugins.widgetselection = {
			startFiller: null, endFiller: null, fillerAttribute: "data-cke-filler-webkit", fillerContent: "\x26nbsp;", fillerTagName: "div", addFillers: function(a) {
				...
				if(this.hasFiller(a) && !this.isWholeContentSelected(a)) {
					var b = a.findOne(this.fillerTagName + "[" + this.fillerAttribute + "\x3dstart]"), d = a.findOne(this.fillerTagName + "[" + this.fillerAttribute + "\x3dend]");
	...
	(function() {
		...
		function aa(a,
			...
			a.addCommand(b.name, {
				exec: function(a, d) {
					...
					if(f && f.name == b.name) f.edit(); else if(b.insert) b.insert({editor: a, commandData: d}); else if(b.template) {
						var f = "function" == typeof b.defaults ? b.defaults() : b.defaults, f = CKEDITOR.dom.element.createFromHtml(b.template.output(f), a.document), g,
							l = a.widgets.wrapElement(f, b.name), k = new CKEDITOR.dom.documentFragment(l.getDocument());
						k.append(l);
		...
		function X(a) {
			...
			b.on("drop", function(c) {
				...
				var f = c.data.dataTransfer, g = f.getData("cke/widget-id"), l = f.getTransferType(b), f = b.createRange(), k = function(a) {
		...
		function U(a) {
			...
			e.on("selectionChange", function(b) {
				var c = (b = h.getNestedEditable(e.editable(), b.data.selection.getStartElement())) && a.getByElement(b), d = a.widgetHoldingFocusedEditable;
		...
		function L(a, b) {
			...
			}(a.editor.config.enterMode), d = new CKEDITOR.dom.element(c);
			"br" !== c && d.appendBogus();
		...
		function Z(a, b) {
			var c = a.editor.config.widget_keystrokeInsertLineBefore, d = a.editor.config.widget_keystrokeInsertLineAfter;
			ia(a);
			O(a);
			ja(a);
			P(a);
			...
			a.on("key", function(b) {
				...
				else if(b == d) L(a, "after"), a.editor.fire("saveSnapshot"); else if(13 == b) a.edit(); else {
		...
		function P(a) {
			if(!0 === a.mask) na(a); else if(a.mask) {
				var b = new CKEDITOR.tools.buffers.throttle(250, oa, a), c = CKEDITOR.env.gecko ? 300 : 0, d, e;
				a.on("focus", function() {
					b.input();
			...
			if(this.wrapper) {
				...
				if(a && "string" != typeof a) {
					...
					b || (b = new CKEDITOR.dom.element("img", this.editor.document),
						b.setAttributes({src: CKEDITOR.tools.transparentImageData, "class": "cke_reset cke_widget_partial_mask"}), this.wrapper.append(b));
					this.mask = b;
		...
		function ka(a) {
			if(a.draggable) {
				...
				if(!a.inline && (d.on("mousedown", pa, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function(a) {
					a.data.preventDefault(!0)
				});
		...
		var u = CKEDITOR.tools.createClass({
			$: function(a, b) {
				...
				createCopyBin: function(a) {
					var b = a.document, c = CKEDITOR.env.edge && 16 <= CKEDITOR.env.version, d = !a.blockless && !CKEDITOR.env.ie || c ? "div" : "span", c = b.createElement(d), b = b.createElement(d);
				...
				handle: function(a) {
					var b = this.copyBin, c = this.editor, d = this.container, e = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, f = c.document.getDocumentElement().$, g = c.createRange(), h = this,
						k = CKEDITOR.env.mac && CKEDITOR.env.webkit, n = k ? 100 : 0, m = window.requestAnimationFrame && !k ? requestAnimationFrame : setTimeout,
						p, r, q;
	...
	(function() {
		...
		e.prototype = {
			...
			_updateNotification: function() {
				...
				var a = this.getTaskCount(), b = {current: this.getDoneTaskCount(), max: a, percentage: Math.round(100 * this.getPercentage())};
		...
		CKEDITOR.tools.extend(CKEDITOR.fileTools, {
			addUploadWidget: function(a, c, f) {
				...
				if(f.fileToElement) a.on("paste", function(d) {
						d =
							d.data;
						var l = a.widgets.registered[c], k = d.dataTransfer, f = k.getFilesCount(), g = l.loadMethod || "loadAndUpload", e, n;
				...
				CKEDITOR.tools.extend(f, {
					downcast: function() {
						...
						var d = this, c = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"), k = b.loaders[c], f = CKEDITOR.tools.capitalize, g, e;
	...
	CKEDITOR.plugins.add("wordcount", {
		version: "1.17.9", requires: "htmlwriter,notification,undo", bbcodePluginLoaded: !1, onLoad: function() {
			...
			function y(a) {
				var b = 0, e = a.length, d;
				a = String(a || "");
				for(d = 0; d < e; d++) var f = encodeURI(a[d]).split("%").length, b = b + (1 == f ? 1 : f - 1);
				return b
			}
			...
			function A(c) {
				var b = c.replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace("\x26nbsp;", " "), b = w(b);
			...
			function m(c) {
				if(document.getElementById(l(c))) {
					var b = 0, d = 0, g = 0, f;
					c.fire("beforeGetData", {firedBy: "wordCount.updateCounter"}, e);
					f = c.getData(!0);
					c.fire("getData", {dataValue: f, firedBy: "wordCount.updateCounter"}, e);
					...
					-1 == n && (n = g);
					-1 == q && (q = b);
					-1 < a.maxWordCount && d > a.maxWordCount && 0 < f || -1 < a.maxCharCount && g > a.maxCharCount && 0 < k || -1 < a.maxParagraphs && b > a.maxParagraphs && 0 < h ? (f = v, v = !0, !a.warnOnLimitOnly && a.hardLimit && ("source" === e.mode && e.plugins.codemirror ? window["codemirror_" +
					e.id].undo() : (c.execCommand("undo"), c.execCommand("undo"))), f || (document.getElementById(l(c)).className = "cke_path_item cke_wordcountLimitReached", c.fire("limitReached", {firedBy: "wordCount.limitReached"}, e))) : (-1 == a.maxWordCount || d <= a.maxWordCount) && (-1 == a.maxCharCount || g <= a.maxCharCount) && (-1 == a.maxParagraphs || b <= a.maxParagraphs) ? (v = !1, a.warnOnLimitOnly || c.fire("saveSnapshot"), document.getElementById(l(c)).className = "cke_path_item") : c.fire("saveSnapshot");
					c.wordCount = {paragraphs: b, wordCount: d, charCount: g};
			...
			var d = "", p = -1, n = -1, q = -1, v = !1, r = 0, h = null, t = function(a, b, d) {
				if("undefined" != typeof document.dispatchEvent) {
					a = "ckeditor.wordcount." + a;
					var e;
					b = {bubbles: !1, cancelable: !0, detail: {currentLength: b, maxLength: d}};
					try {
			...
			e.on("paste",
				function(c) {
					if(!a.warnOnLimitOnly && (0 < a.maxWordCount || 0 < a.maxCharCount || 0 < a.maxParagraphs)) {
						var b = -1, d = -1, e = -1, f = c.editor.getSelection().getNative().toString().trim();
						c.editor.fire("beforeGetData", {firedBy: "wordCount.onPaste"}, c.editor);
						var k = c.editor.getData(!0);
						c.editor.fire("getData", {dataValue: k, firedBy: "wordCount.onPaste"}, c.editor);
						...
						a.showParagraphs &&
						(e = z(k));
						null === h && (h = new CKEDITOR.plugins.notification(c.editor, {message: c.editor.lang.wordcount.pasteWarning, type: "warning", duration: a.pasteWarningDuration}));
