...
final public class ServerTools
{
	...
	{
		if(m_myhostname != null) return m_myhostname;
	...
	static public String	getMimeType(String fn)
	{
		...
		if(xi == -1) return null;					// No suffix -> unknown MIME
	...
	static public synchronized void initMimeMap() 
	{
		...
		final String[] premimes =
		{
			...
			"dwt", "application/x-dreamweaver-tpl",
