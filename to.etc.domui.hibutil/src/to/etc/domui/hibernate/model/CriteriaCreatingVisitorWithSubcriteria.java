 ...
 */
public class CriteriaCreatingVisitorWithSubcriteria extends QNodeVisitorBase {
	...
	public CriteriaCreatingVisitorWithSubcriteria(Session ses, final Criteria crit) {
		m_session = ses;
		m_rootCriteria = crit;
