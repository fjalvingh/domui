...
/**
 * This helps with generating all font names. It is not really necessary.
 *
...
final public class FaIconGenerator {
	...
	static private final String[] FANAMES = {
		...
		"fa-volume-down", "fa-volume-off", "fa-volume-up", "fa-warning", "fa-weibo", "fa-weixin", "fa-whatsapp", "fa-wheelchair",
