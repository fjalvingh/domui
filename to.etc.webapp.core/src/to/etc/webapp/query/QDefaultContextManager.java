...
public class QDefaultContextManager implements IQContextManager {
	...
	@Override
	@Nonnull
	public QDataContextFactory getSharedContextFactory(@Nonnull QContextContainer cc) {
...
//		src = new UnclosableContextFactory(cc, getDataContextFactory());
	...
	@Nonnull
	@Override
	public QDataContext getSharedContext(@Nonnull QContextContainer cc) throws Exception {
	 ...
	 */
	@Override
	public void closeSharedContext(@Nonnull QContextContainer cc) {
		QDataContext dc = cc.internalGetSharedContext();
		if(dc == null)
			return;
