...
public class QSelection<T> extends QCriteriaQueryBase<T> {
	protected QSelection(Class<T> clz) {
		super(clz);
	}
	...
	@Override
	@Deprecated
	public @Nonnull QSelection<T> or(final @Nonnull QOperatorNode a1, final @Nonnull QOperatorNode a2, final @Nonnull QOperatorNode... a) {
