...
public class TestBasic {
	...
	////		m_dc = TUtilSetupDB.getQDataContext();
	//		Assert.fail("cycle dependancy with moca.database");
	//	}
	//
	...
	//			if(ix++ > 10)
	//				break;
	//			System.out.println("la: " + la.gweetCode() + ", " + la.getDescription() + ", " + la.getTypeDescription() + ", " + la.getId());
	//		}
