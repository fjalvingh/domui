...
public class CompressedTarUtilTest {
	...
	public void testCreateCompressedTarArchive() throws IOException {
		...
		try(
			...
			CompressedTarUtil.tar(fos, it -> System.out.println("size so far: " + it), rootLocation, "NT15_BZK_dVi_20210120.b - testsuite");
		}
	...
	public void testExtractCompressedTarArchive() throws IOException {
		...
		try(FileInputStream fis = new FileInputStream(targzFile)) {
			CompressedTarUtil.untar(extractLocation, fis, it -> System.out.println("size so far: " + it));
		}
