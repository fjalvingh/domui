...
abstract public class AbstractTaskExecutor<T> extends Thread {
	private final BulkTaskRunner<T, ? extends AbstractTaskExecutor<T>> m_runner;
	...
	public AbstractTaskExecutor(BulkTaskRunner<T, ? extends AbstractTaskExecutor<T>> runner) {
		m_runner = runner;
	}
