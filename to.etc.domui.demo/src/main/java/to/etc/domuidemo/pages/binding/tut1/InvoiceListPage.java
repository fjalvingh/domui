...
import to.etc.domuidemo.pages.binding.tut1.binding.EditInvoicePageB1;
 ...
 */
@NonNullByDefault
final public class InvoiceListPage extends UrlPage {
	@Override
	public void createContent() throws Exception {
		...
		sp.setOnNew(a -> UIGoto.moveSub(EditInvoicePageB1.class, "invoice", "NEW"));
	}
	...
	private void showResult(NodeContainer target, @Nullable QCriteria<Invoice> criteria) throws Exception {
		...
		rr.setRowClicked(invoice -> UIGoto.moveSub(EditInvoicePageB1.class, "invoice", invoice.getId()));
