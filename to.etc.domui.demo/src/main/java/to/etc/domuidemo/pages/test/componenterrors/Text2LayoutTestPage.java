...
public class Text2LayoutTestPage extends UrlPage {
	...
	@Override public void createContent() throws Exception {
		...
		d.add(t2);
		t2.addButton(FontIcon.faAddressBookO, a -> {});
		...
		d.add(t3);
		t3.addButton(FontIcon.faAddressBookO, a -> {});
		t3.addButton(FontIcon.faAnchor, a -> {});
		...
		t23.addButton(FontIcon.faFile, a -> {}).css("is-primary");
