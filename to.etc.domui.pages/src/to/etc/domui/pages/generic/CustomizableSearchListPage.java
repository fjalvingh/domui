...
/**
 * Enable additional custimizations on generic page handling some cruddy stuff.
 *
 * @author <a href="mailto:jal@etc.to">Frits Jalvingh</a>
 * Created on Oct 16, 2008
 */
abstract public class CustomizableSearchListPage<T> extends BasicPage<T> {
	...
	public CustomizableSearchListPage(Class<T> clz, String titlekey) {
		super(clz, titlekey);
	}
	...
	abstract protected void customizeLookupForm(LookupForm<T> lf);
	...
	abstract protected SimpleRowRenderer provideRowRenderer();
