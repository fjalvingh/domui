...
public class StatelessSessionImpl extends AbstractSessionImpl
	...
	StatelessSessionImpl(final Connection connection, final SessionFactoryImpl factory, final DataSource perSessionDS) {
		super( factory );
		this.jdbcContext = new JDBCContext( this, connection, EmptyInterceptor.INSTANCE, perSessionDS);
	}
